...
class Assessor_reg_model extends CI_Model
{
	...
	public function assessor_migrate($assessor_draft_array = NULL, $insert_id_hash = NULL){
		...
		$this->db->trans_begin(); // 24-03-2021
		//query 1
		$this->db->insert('council_assessor_registration_details', $assessor_draft_array);
		$insert_id = $this->db->insert_id();

		//query 2 24-03-2021 start
		
		$assessor_application_number = array(
			"assessor_registration_details_fk" => $insert_id,
		...
		$this->db->insert('council_assessor_registration_application_nubmer',$assessor_application_number);// 24-03-2021
		//query 2 24-03-2021 end
