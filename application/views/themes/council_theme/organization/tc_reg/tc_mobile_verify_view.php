        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="breadcrumb-box">
                    <h2 class="breadcrumb-title">TC LOGIN</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">TC/Institute</a></li>
                        <li class="breadcrumb-item active">Organization Mobile Verification</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section class="pt-5 pb-5">
    <div class="container">
        ...
        <h5 class="text-center">
            <strong>Organization Mobile Verification</strong>
        </h5>
        <hr>
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card border-secondary mb-3">
                    ...
                    <div class="card-body text-dark">
                        <?php echo form_open_multipart('organization/tc_reg/mobile_verify/' . $id) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 offset-md-3 text-center">
                                <p class="mt-4">
                                    ...
                                    <br>
                                    <a href="<?php echo base_url('organization/tc_reg/resend_otp/' . $id); ?>">
