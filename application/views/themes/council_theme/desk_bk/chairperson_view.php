...
<section class="pt-5 pb-5">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <img class="img-thumbnail" src="<?php echo $this->config->item('theme_uri');?>councils/images/subrata-banerjee.jpg">
                </div>
            </div>
            <div class="col-md-8">
                <div class="caption mt-3">
                    <h4>Subrata Banerjee</h4>
                ...
                <div class="contacts">
                    ...
                    <span><i class="fa fa-envelope-o"></i> <a href="#">chairperson@mail.com</a></span>
                </div>
            </div>
        </div>
    </div>
