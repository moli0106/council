        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo set_value("fullname"); ?>" name="fullname" id="fullname"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input id="stdEmail" name="stdEmail" class="form-control" type="email"  placeholder="Email"
                        value="<?php echo set_value('stdEmail'); ?>">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" id="stdMobileNo" name="stdMobileNo"  class="form-control"  placeholder="Mobile No"
                        value="<?php echo set_value('stdMobileNo'); ?>">
