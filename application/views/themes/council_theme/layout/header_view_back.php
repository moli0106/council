                                ...
                                <ul class="navbar-nav">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="coming_soon">Desk</a>
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item" href="desk/p_secretary">Pr. Secretary & Ex Officio Vice Chairperson</a></li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="admission/stvt">STVT</a></li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu">
                                                <!-- <a class="dropdown-item dropdown-toggle" href="javascript:void(0)">NQR Listed Course</a> -->
                                                <a class="dropdown-item dropdown-toggle" href="javascript:void(0)">NQR listed STT</a>
                                                <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu">
                                                <!-- <a class="dropdown-item dropdown-toggle" href="javascript:void(0)">VIII+/X+ STC</a> -->
                                                <a class="dropdown-item dropdown-toggle" href="javascript:void(0)">NSQF structured STT</a>
                                                <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu">
                                                <!-- <a class="dropdown-item dropdown-toggle" href="javascript:void(0)">STVT</a> -->
                                                <a class="dropdown-item dropdown-toggle" href="javascript:void(0)">Other STT</a>
                                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="coming_soon">Institute Login</a>
                                                <ul class="dropdown-menu">
                                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="coming_soon">VTC / STTC / Polytechnic Login</a>
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item" href="online_app/inst/vtc/affiliation">Affiliation Apply / Renewal</a></li>
                                                    ...
                                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="coming_soon">Polytechnic Login</a>
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a class="dropdown-item" target="_blank" href="https://affiliation.webscte.co.in/">Renewal of affiliation</a></li>
                                                            <li><a class="dropdown-item" href="coming_soon">Grievance</a></li>
                                                            <li><a class="dropdown-item" href="coming_soon">Suggestion</a></li>
                                                        </ul>
                                                    </li>
                                            ...
                                            <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="coming_soon">Student Login</a>
                                                <ul class="dropdown-menu">
                                                    <li class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="coming_soon">Polytechnic</a>
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" target="_blank" href="admin/student_login">Login</a></li>
                                            ...
                                            <li><a class="dropdown-item" target="_blank" href="online_application_various_courses/registration">Online registration various courses</a></li>
