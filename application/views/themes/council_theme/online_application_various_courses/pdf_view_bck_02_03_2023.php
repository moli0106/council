...
<body>
    ...
    <table width="100%" style="border: 1px solid;">
        <tr>
            <td align="center">
                ACKNOWLEDGEMENT RECEIPT FOR <strong><?php echo $user_details[0]['course_name']; ?>&nbsp;<?php echo $user_details[0]['registration_year']; ?></strong>
                <p style="font-size: 12px;"> Admission to Diploma Institutes <?php echo $user_details[0]['course_name']; ?> in West Bengal for the Academic Session <?php echo $user_details[0]['registration_year']; ?><?php echo date("Y") ?>-<?php echo date('Y', strtotime('+1 year'));?></p></strong>
            </td>
        </tr>
    </table>
    <table width="100%" style="border: 1px solid;">
        <tr>
            ...
            <td rowspan="5" align="middle" width="10%">
    ...
    <br><br>
    <?php 
    If($user_details[0]['course_id_fk']==1 ||$user_details[0]['course_id_fk']==9||$user_details[0]['course_id_fk']==5){ ?>
    <table width="100%" style="border: 1px solid;">
