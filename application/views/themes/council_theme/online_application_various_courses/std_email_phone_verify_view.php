...
<section class="pt-5 pb-5">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
					...
					<?php if ($this->input->method(TRUE) == 'GET') { ?>
                        <input type="text" value="<?php if(isset($bsk_data)){echo $bsk_data['citizenname'];}?>" name="fullname" id="fullname" class="form-control" placeholder="Name">
                    <?php }else{?>
                        <input type="text" value="<?php echo set_value("fullname"); ?>" name="fullname" id="fullname" class="form-control" placeholder="Name">
                    <?php }?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <!--input type="number" id="stdMobileNo" name="stdMobileNo" class="form-control" placeholder="Mobile No" value="<?php echo set_value('stdMobileNo'); ?>"-->
					 <?php if ($this->input->method(TRUE) == 'GET') { ?>
                        <input type="number" id="stdMobileNo" name="stdMobileNo" class="form-control" placeholder="Mobile No" value="<?php if(isset($bsk_data)){echo $bsk_data['citizenmobile'];}?>">
            ...
            <input type="hidden" name="bsk_ticket_no" value="<?php if(isset($bsk_data)){echo $bsk_data['ticketno'];}?>">
