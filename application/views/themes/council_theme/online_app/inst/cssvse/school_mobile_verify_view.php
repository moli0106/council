            ...
            <div class="col-md-12 text-center">
                <div class="breadcrumb-box">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">HOI Mobile Verification</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section class="pt-5 pb-5">
    <div class="container">
        ...
        <h5 class="text-center">
            <strong>HOI Mobile Verification</strong>
        </h5>
        <hr>
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card border-secondary mb-3">
                    ...
                    <div class="card-body text-dark">
                        <?php echo form_open_multipart('online_app/inst/cssvse/registration/mobile_verify/' . $id) ?>
                        <h4>Verify One Time Passcode <small class="text-warning font-weight-bold"></small></h4>
                        <hr>
                        <p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="otp" name="otp" class="form-control <?php echo (form_error('otp') != '') ? 'is-invalid' : ''; ?>" type="number" value="<?php echo set_value('otp'); ?>">
                            ...
                            <div class="col-md-6 offset-md-3 text-center">
                                <p class="mt-4">
                                    ...
                                    <br>
                                    <a href="<?php echo base_url('online_app/inst/cssvse/registration/resend_otp/' . $id); ?>">
