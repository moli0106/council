            ...
            <div class="col-md-6 offset-md-3">
                <div class="card border-secondary mb-3">
                    ...
                    <div class="card-body text-dark">
                        <?php echo form_open_multipart('polytechnic/transfer/mobile_verify/' . $id) ?>
                        ...
                        <p>
                            ...
                            <i><?php echo $mobile; ?>.<?php echo $otp; ?>.</i>
                        </p>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6 offset-md-3 text-center">
                                <p class="mt-4">
                                    ...
                                    <br>
                                    <a href="<?php echo base_url('polytechnic/transfer/resend_otp/' . $id); ?>">
