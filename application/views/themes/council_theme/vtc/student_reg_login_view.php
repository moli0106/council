        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="btn-div">
                    ...
                    <a href="<?php echo base_url('admin/student_login'); ?>" target="_blank" class="my-btn btn-login">Student Login</a>
                    <a href="<?php echo base_url('vtc/student_reg'); ?>" target="_blank" class="my-btn btn-reg" id="student_regsss">Student Registration</a>
                </div>
                <i class="text-danger pull-right" style="margin-top: 35px;">* If you are already registered, Click Student Login</i>
            </div>
        </div>
