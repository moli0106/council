        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="breadcrumb-box">
                    <h2 class="breadcrumb-title">VTC</h2>
                    <ol class="breadcrumb">
...
<section class="pt-5 pb-5">
    <div class="container">
        ...
        <h4>
            <strong>
                VTC Student Registration Portal
            </strong>
        </h4>
        <hr>
        <div class="card border-primary mb-3">
            <div class="card-header">VTC Student Registration</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input id="instituteCode" name="vtcCode" class="form-control" type="text" value="<?php echo set_value('vtcCode'); ?>">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input id="vtcName" name="vtcName" class="form-control" type="text" value="<?php echo set_value('vtcName'); ?>" readonly>
                            <?php echo form_error('vtcName'); ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="udise_code">UDISE / AISHE Code</label>
                            <input id="udise_code" name="udise_code" class="form-control" type="text" value="<?php echo set_value('udise_code'); ?>" readonly>
                    ...
                    <div class="row question-box-row">
                        <div class="col-md-12">
                            <div class=" border-dark mb-3">
                                ...
                                <div class="vtc_last_exam_div" <?php if ((set_value('registration_for') == 2 ) || (set_value('registration_for') == NULL)) echo 'style="display: none;"'; ?>>
                                ...
                                <div class="insLastExamDiv" <?php if ((set_value('registration_for') == 1 ) || (set_value('registration_for') == NULL)) echo 'style="display: none;"'; ?>>
                                    <?php $this->load->view($this->config->item('theme').'vtc/institute_last_exam_view');?>
