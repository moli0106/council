...
class Empanelled_assessor_list_model extends CI_Model {
   ...
   public function get_assessor($limit = NULL, $offset = NULL){
    $query = $this->db->select("assessor.assessor_registration_details_pk,assessor.fname,assessor.mname,assessor.lname,assessor.pan,assessor.assessor_code,assessor.mobile_no,assessor.process_status_id_fk,sector.sector_name")
		...
		->order_by("sector.sector_name,assessor.fname")
        ->get();
   ...
   public function get_assessor_search($pan_no = NULL ,$ssc_wbsctvesd_certified = NULL) {
    ...
    $this->db->select("assessor.assessor_registration_details_pk,assessor.fname,assessor.mname,assessor.lname,assessor.pan,assessor.assessor_code,assessor.mobile_no,assessor.process_status_id_fk,sector.sector_name");
