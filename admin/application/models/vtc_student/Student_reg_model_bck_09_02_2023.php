...
class Student_reg_model extends CI_Model
{
    ...
    public function getStudentListByVTCId($limit, $start, $orderColumn, $orderType,$selected_year,$vtc_id_pk){
        ...
        $this->db->select('
            student.*,course_name_master.course_name,group_master.group_name,group_master.group_code
        ');
        $this->db->from('council_vtc_student_master AS student');
        ...
        $this->db->order_by('group_master.group_code');
	...
	public function getStudentListBySearch($limit = NULL, $offset = NULL, $orderColumn, $orderType, $search, $selected_year,$vtc_id_pk)
    {
        $this->db->select('
            student.*,course_name_master.course_name,group_master.group_name,group_master.group_code
        ');
