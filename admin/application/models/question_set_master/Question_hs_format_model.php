...
class Question_hs_format_model extends CI_Model
{
    ...
    public function get_question_format_main_count()
    {
        $query = $this->db->select("count(question_format_main_id_pk)")
            ...
            ->where_in('course_id_fk',array(1,2))
            ->get();
    ...
    {
        $query = $this->db->select("que_format_main.question_format_main_id_pk,que_format_main.month_year,course.course_name,semester.semester_name,subject.subject_name,subject.subject_code,que_code.question_code,que_format_main.question_set_status")
            ...
            ->where_in('que_format_main.course_id_fk',array(1,2))
            ->limit($limit, $offset)
    ...
    public function getQuestionCodeDetails($subject_id = NULL)
    {
        $this->db->select('QCM.question_code_id_pk, QCM.question_code, subject.subject_id_pk, subject.subject_name, subject.subject_code');
        $this->db->from('council_qbm_question_code_master AS QCM');
        ...
        $this->db->where('subject.subject_id_pk', $subject_id);
    ...
    public function getQuestionTypeMarksList($subject_id = NULL, $sam_year_id = NULL)
    {
        $this->db->select('qtmm.question_type_mark_id_pk, qtmm.question_type_name, qtmm.question_mark');
        //$this->db->from('council_qbm_question_code_master AS qcm');
        $this->db->from('council_qbm_subject_question_type_mark_map sqtmm');
        ...
        $this->db->where('sqtmm.sem_year_id_fk', $sam_year_id);
    ...
    {
        $query = $this->db->select("que_format_main.question_format_main_id_pk,que_format_main.month_year,course.course_name,semester.semester_name,subject.subject_name,subject.subject_code,que_code.question_code,time_allowed.time_allowed,full_mark.full_marks,que_format_main.no_question_category_type")
            ->from("council_qbm_question_format_main as que_format_main")
            ->join("council_qbm_course_master as course", "course.course_id_pk = que_format_main.course_id_fk")
            //->join("council_qbm_discipline_master as discipline", "discipline.discipline_id_pk = que_format_main.discipline_id_fk")
            ->join("council_qbm_semester_master as semester", "semester.semester_id_pk = que_format_main.sem_year_id_fk")
    ...
    {
        $query = $this->db->select("que_format_main.question_format_main_id_pk,que_format_main.month_year,course.course_name,semester.semester_name,subject.subject_name,subject.subject_code,que_code.question_code,time_allowed.time_allowed,full_mark.full_marks")
            ->from("council_qbm_question_format_main as que_format_main")
            ->join("council_qbm_course_master as course", "course.course_id_pk = que_format_main.course_id_fk")
            //->join("council_qbm_discipline_master as discipline", "discipline.discipline_id_pk = que_format_main.discipline_id_fk")
            ->join("council_qbm_semester_master as semester", "semester.semester_id_pk = que_format_main.sem_year_id_fk")
    ...
    public function get_question_code($subject_id = NULL)
    {
        $query = $this->db->select("que_code.question_code_id_pk,que_code.question_code")
            ->from("council_qbm_question_code_master as que_code")
            ->where(
                array(
                    "que_code.active_status"     => 1,
                    "que_code.subject_id_fk"     => $subject_id
                )
            )
