...
class Question_code_model extends CI_Model {
    ...
    public function getAllcourse(){
        $query = $this->db->select("*")
            ...
            ->where_in('course_id_pk',array(3,4))
    ...
    public function get_subject_List($course_id = NULL,$discipline_id = NULL)
    {
    ...
    {
        $query = $this->db->select("course.course_name,que_code.question_code_id_pk,que_code.question_code,discipline.discipline_name,discipline.discipline_code,semester.semester_name,subject.subject_name,subject.subject_code")
            ...
            ->where_in('que_code.course_id_fk',array(3,4))
            ->limit($limit, $offset)
    ...
    public function get_same_subject_data_hsvoc($course_id,$discipline_id,$sam_year_id,$subject_id){
