...
$config['CSSVSE_ASSESSMENT'] = array(
    ...
    'batch_push'  => 'http://localhost/council_live/api_rest_server/assessment_batch/create_assessment_batch',
    //'trainee_image'  => 'http://172.20.140.171/api_rest_server/assessment_batch/trainee_document',
    'trainee_image'  => 'http://localhost/council_live/api_rest_server/assessment_batch/trainee_document',
);
