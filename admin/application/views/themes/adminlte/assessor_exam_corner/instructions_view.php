...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="assessor_exam_corner/online_exam"><i class="fa fa-align-center"></i> Exam Corner</a></li>
      <li class="active"><i class="fa fa-align-center"></i>Online Exam</li>
    </ol>
  </section>
        ...
        <table class="table table-bordered">
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo date('d-m-Y', strtotime($examDetails['batch_exam_date'])) . ' (<i>' . date('l', strtotime($examDetails['batch_exam_date'])) . '</i>)'; ?></td>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-4 col-md-offset-4 text-center end-exam" <?php if (($examDetails['exam_status'] != 2)) echo 'style="display: none"'; ?>>
      ...
      <?php if (($examDetails['exam_status'] != 2) && (($examDetails['exam_start_time'] == NULL) || (strtotime($examDetails['exam_start_time']) + (90 * 60)) > strtotime(date('H:i:s')))) { ?>
