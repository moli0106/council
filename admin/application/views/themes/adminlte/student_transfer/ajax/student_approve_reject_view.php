...
<?php echo form_open("admin/student_transfer/student_list/updateStudentApproveRejectStatus", array("id" => "verify_reject_form")); ?>
...
<input type="hidden" name="transfer_ins_id" value="<?php echo $student_data['institute_id']; ?>">
<input type="hidden" name="transfer_course_id" value="<?php echo $student_data['discipline_id_fk']; ?>">
      ...
      <div class="approve_btn">
        <div class="approve_btn_main">
            <button type="submit" class="btn btn-success btn-block btn-flat approve-btn" name="submitVtcApprove" value="1">
              <i class="fa fa-thumbs-up" aria-hidden="true"></i>  Verify
            </button>
        </div>
        <div class="approve_btn_main">
