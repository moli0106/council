 ...
 <div class="content-wrapper">
  ...
  <div class="row mt-4 margin-top">
    ...
    <?php if ($this->session->flashdata('status')) { ?>
          <div class="alert alert-<?php echo $this->session->flashdata('status') == 'success' ? 'success' : 'danger'; ?>">
    ...
    <div class="col-sm-6 shadow ov"> 
	      <table class="table table-striped bg-white mt-2" id="tbl_posts">
	        ...
	        <tbody id="sample_table">
	          ...
	          <tr id='rec-<?php echo $row['vtc_id_pk'] ?>'>
	            ...
	            <td><?php echo $row['available_intake'] ?></td>
	            <td><?php echo $row['category_name'] ?></td>
	            <td><a class="btn btn-xs add-record btn btn-success" data-id='<?php echo $row['vtc_id_pk'] ?>' data-institute='<?php echo $row['vtc_name'] ?>' data-courseid='<?php echo $row['discipline_id_fk'] ?>' data-course='<?php echo $row['discipline_name'] ?>' data-type='<?php echo $row['category_name'] ?>'>Add</a></td>
	          </tr>
	          <?php
	           }
	          ?>
		...
		<?php echo form_open_multipart("admin/student_transfer/choice_filling/save_filling_data", array('id' => 'choice-filling-form')); ?>
...
<script type="text/javascript">
  $(document).ready(function(){
     ...
     debugger;
       ...
       var rowHtml='<tr><td><input type="hidden" class="form-control p" data-id='+final_id+'  name="priority[]" value="'+count+'" readonly><span class="sn">'+count+'<span></td>'
            ...
            +'<td>'+course+'<input type="hidden" class="form-control" name="course_id[]" value="'+course_id+'" readonly><input type="hidden" class="form-control" name="course[]" value="'+course+'" readonly></td>'
  ...
  /* This method will delete a row */
    ...
    jQuery(window).on("load", function(){
      $.ajax({
        url:"student_transfer/choice_filling/institute_fetch",
        type: "GET",
        success:function(data){
          ...
          $.each(result.data, function(index, value){
            ...
            +'<td>'+value.course_name+'<input type="hidden" class="form-control" name="course_id[]" value="'+value.discipline_id_fk+'" readonly><input type="hidden" class="form-control" name="course[]" value="'+value.course_name+'" readonly></td>'
