        ...
        <div class="box">
            ...
            <?php echo form_open_multipart(base_url('admin/'.uri_string()),array('autocomplete'=> 'off'));?>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="" for="">Sector :</label><br>
                            <?php echo $questions[0]['sector_name'];?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="" for="">Course :</label><br>
                            <?php echo $questions[0]['course_name'];?>
                        </div>
                    </div>

                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="" for="">Name of Programme :</label><br>
                            
                            <?php echo $questions[0]['programme_name']; ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="" for="">Question for :</label><br>
                            
                            <?php echo $questions[0]['question_for_name']; ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="" for="">Question Type :</label><br>
                            <?php echo $questions[0]['question_type_name']; ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if($questions[0]['question_for_id']==2){?>
                            <label class="" for="">Module :</label><br>
                            <?php echo $questions[0]['module_name']; ?>
                            <?php } else{?>
                                <label class="" for="">NoS Name :</label><br>
                                <?php echo $questions[0]['nos_name']; ?>
                            <?php }?>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <?php if($questions[0]['question_pic']!=''){?>
                        <div class="col-md-3 que_pic_hide_show" style="<?php echo $questions[0]['question_pattern'] == '2' ? "" : "display:none";?>">
                            <div class="imgcard">
                ...
                <div class="row">
                    ...
                    <?php if($questions[0]['option1_pic']!=''){?>
                ...
                <div class="row">
                    ...
                    <?php if($questions[0]['option2_pic']!=''){?>
                        <div class="col-md-4 option_pic_hide_show" style="<?php echo $option_pattern == '2' ? "" : "display:none";?>">
                ...
                <div class="row">
                    ...
                    <?php if($questions[0]['option3_pic']!=''){?>
                        <div class="col-md-4 option_pic_hide_show" style="<?php echo $option_pattern == '2' ? "" : "display:none";?>">
                            <div class="imgcard_option mbotm20">
                ...
                <div class="row">
                    <div class="col-md-6 option_text_hide_show" style="<?php echo $option_pattern == '2' ? "display:none" : "display:block";?>">
                      <div class="form-group">
                            <label class="" for="">Option D<span class="text-danger">*<span></label>
                            <?php if($this->input->method(TRUE) == 'GET') {?>
                    ...
                    <?php if($questions[0]['option4_pic']!=''){?>
                        <div class="col-md-4 option_pic_hide_show" style="<?php echo $option_pattern == '2' ? "" : "display:none";?>">
                            <div class="imgcard_option mbotm20">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="" for="">Correct Answer</label><br>
                            <?php echo $question_answer[0]['right_answer']?>
                            <!-- <input type="hidden" name="correctAns" value="<?php //echo $question_answer[0]['right_answer']?>"> -->
                        </div>
                    </div>
                </div>
                <div class="row">
