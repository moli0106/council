...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Affiliation - Teachers / Instructor Details</h1>
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-align-center"></i> Teachers / Instructor Details</li>
        </ol>
    </section>
            ...
            <div class="col-md-3">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <a href="<?php echo base_url('admin/affiliation/vtc/download_qualification_certificate/' . md5($teacher['teacher_id_pk'])); ?>" class="label label-info">
                        ...
                        <a href="<?php echo base_url('admin/affiliation/vtc/download_pan_image/' . md5($teacher['teacher_id_pk'])); ?>" class="label label-info">
                            <i class="fa fa-download" aria-hidden="true"></i>
                            Download
                        </a>
                        ...
                        <?php if ($teacher['aadhar_no_image'] != NULL) { ?>
                            <a href="<?php echo base_url('admin/affiliation/vtc/download_aadhar_image/' . md5($teacher['teacher_id_pk'])); ?>" class="label label-info">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h2 class="page-header">
                                    <i class="fa fa-user"></i> <?php echo $teacher['teacher_name']; ?>
                                </h2>
                            </div>
                        </div>
                        <div class="row">
