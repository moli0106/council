        ...
        <?php if (!empty($vtcDetails)) { ?>
                        ...
                        <div class="box box-success">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    ...
                                    <button class="btn btn-danger btn-sm" id="resetSubjectSelection">Reset Subject
                                        Selection</button>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="" for="groupSelection">Select group/trade <span
                                            ...
                                            <select class="form-control" name="group_id" id="groupSelection">
                                                ...
                                                <option value="<?php echo  $val['group_id_pk']?>"
                                                    <?php echo set_select('group_id', $val['group_id_pk']) ?>>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="" for="class_name">Select Class <span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="" for="category_id">Select Subject Category <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="" for="subject_name_id">Select Subject Name <span class="text-danger"> ( You May Select Multiple Subject , <b class="text-success">Please check curriculum structure before choosing</b> )*</span></label>
                                            <select class="form-control select2" name="subject_name_id[]" id="subject_name_id"
                                                multiple="multiple">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-md-offset-4">
                                        ...
                                        <button type="button" class="btn btn-success btn-block btn-sm"
                                            id="subject-selection-btn">Submit Subject Selection</button>
                                        <?php //} ?>
                                    </div>
                                </div>
                                <?php } ?>
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    ...
                                    <a href="<?php echo base_url('admin/affiliation/subject/downloadExcelForSubject') ?>" class="btn btn-success btn-sm">
                                        <i class="fa fa-download" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Download H.S Subject
                                    </a>
                                </div>
                            </div>
            ...
            <?php }else { ?>
                <div class="alert alert-warning alert-dismissible">
                    ...
                    Not applicable as no HS (Voc) course is selected <span
