...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <?php echo form_open('admin/council/new_course',array("id"=> "course_entry_form")) ?>
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action_buttons">
                                ...
                                <a href="council/new_course/map_domain_qualification/<?php echo md5($course['course_id_pk']) ?>" alt="" class="btn btn-xs btn-info">Map Domain</a>
                            </td>
                        </tr>
                        <?php $i++; } ?>
                    </tbody>
