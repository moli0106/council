    ...
    <section class="content">
        ...
        <div class="box box-primary">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php } else { ?>
                            ...
                            <input type="checkbox" class="apply_for_expert" name="apply_for_expert" value="1" <?php echo $assessor[0]["apply_for_expert"] == 1 ? "checked" : ""; ?> <?php echo $disabled;?> />  <span>Expert</span>
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="assessor_profile/assessor_registration/basic" class="btn btn-primary btn-space">Previous</a>
                    <a href="assessor_profile/assessor_registration/edu_quali_indus_profe_exp" class="btn btn-primary btn-space">Next</a>
                </div>
                <?php if($app_data[0]['final_flag'] != 't'){ ?>
