		...
		<div class="box-header with-border">
			...
			<div class="box-body box-profile">
				...
				<li><a href="assessor_profile/assessor_registration/basic">Basic</a></li>
                    ...
                    <li><a href="assessor_profile/assessor_registration/professional_details">Professional details</a></li>
				...
				?>
					...
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						...
						<li>
						<i class="fa <?php echo $app_data[0]['experience_assessor_flag'] == 't' ? 'fa-check bg-green' : 'fa-close bg-red'; ?>"></i>
						<div class="timeline-item">
						...
						<div class="timeline-item">
							<h3 class="timeline-header"><a href="assessor_profile/assessor_registration/professional_details">Professional details</a> 
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
					...
					<?php if($app_data[0]['basic_flag'] == 't' && $app_data[0]['course_flag'] && $app_data[0]['edu_qualification_flag'] && $app_data[0]['residential_address_flag'] && $app_data[0]['work_experience_flag'] && $app_data[0]['experience_assessor_flag'] && $app_data[0]['professional_details_flag']){ ?>
					...
					<div class="btn-group">
					<a href="assessor_profile/assessor_registration/professional_details" class="btn btn-primary confirm_pre"> < Previous</a>
					</div>
				</div>
			</div>
