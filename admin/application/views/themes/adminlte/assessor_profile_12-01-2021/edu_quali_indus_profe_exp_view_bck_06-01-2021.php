  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php } elseif($this->input->method(TRUE) == "GET") { ?>
                            ...
                            <input type="radio" class="assessor_certified_status" name="certified" value="0" <?php echo $assessor[0]["certified_by_any_assessor"]  == NULL ? "checked" : ""; ?> <?php echo $disabled; ?> />  <span>No</span>
                            <?php } ?>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="agency_block" style="display:<?php echo $assessor[0]["certified_by_any_assessor"] == 1 ? "block" : "none" ?> ?>">
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="assessor_profile/assessor_registration/course" class="btn btn-primary btn-space">Previous</a>
                    <a href="assessor_profile/assessor_registration/contact" class="btn btn-primary btn-space">Next</a>
                </div>
                <?php if($app_data[0]['final_flag'] != 't'){ ?>
