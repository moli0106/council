        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <li><a href="assessor_profile/assessor_registration/basic">Basic</a></li>
                    ...
                    <li class="active"><a href="assessor_profile/assessor_registration/professional_details">Professional<br> details</a></li>
                ...
                <?php if($app_data[0]['final_flag'] != 't'){ ?>
                <h4>Professional details<span style="color:#F00; font-size:14px;">(At least one Professional is mandatory for each Assessor.)</span></h4><hr>
