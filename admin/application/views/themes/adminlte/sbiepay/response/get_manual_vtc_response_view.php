...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <?php echo form_open("admin/sbiepay/response/vtcBlankResponse", array("id" => "sbi_vtc_response_form")); ?>
                    <div class="row">
                        <!-- <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="payment_type_id_fk" id="payment_type_id_fk">
                                    ...
                                    <option value="1" <?php echo set_select('payment_type_id_fk', '1')?>>Student Reg Fee</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="submit" class="btn btn-warning btn-block btn-flat" id="upd_vtc_sbi_response">Update Response</button>
                        </div>
                    </div>
                <?php echo form_close() ?>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#upd_vtc_sbi_response', function(e) {
        e.preventDefault();
        // alert('jjj');
        var error = 0;
        ...
        var action_page = $("#sbi_vtc_response_form").attr("action");
                ...
                Swal.fire({
                    ...
                    didOpen: () => {
                        ...
                        $.ajax({
                                ...
                                dataType: "json",
                                url: action_page,
                                data: $("#sbi_vtc_response_form").serialize(),
                            })
                            .done(function(response) {
								...
								$.ajaxSetup({async:false});
								$.post( "sbiepay/response/upd_vtc_merchant_no", { transaction_id: Object.assign({}, myarray) })
								 .done(function( data1 ) {
