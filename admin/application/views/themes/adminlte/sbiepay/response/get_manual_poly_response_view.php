    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>Response List</h3>
                <div class="box-tools pull-right"></div>
            </div>
            <div class="box-body">
                <?php echo form_open("admin/sbiepay/response/polyAffiliationBlankResponse", array("id" => "sbi_poly_response_form")); ?>
                    <div class="row">
                        <!-- <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="payment_type_id_fk" id="payment_type_id_fk">
                                    ...
                                    <option value="9" <?php echo set_select('payment_type_id_fk', '9')?>>Polytechnic Affiliation Fees</option>
                                    <!-- <option value="5" <?php echo set_select('payment_type_id_fk', '5')?>>Student Exam Fee</option> -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="submit" class="btn btn-warning btn-block btn-flat" id="upd_poly_affiliation_sbi_response">Update Response</button>
                        </div>
                    </div>
                <?php echo form_close() ?>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#upd_poly_affiliation_sbi_response', function(e) {
        e.preventDefault();
        // alert('jjj');
        var error = 0;
        ...
        var action_page = $("#sbi_poly_response_form").attr("action");
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    ...
                    didOpen: () => {
                        ...
                        // $("#sbi_vtc_response_form").submit();
                        $.ajax({
                                type: "POST",
                                dataType: "json",
                                url: action_page,
                                data: $("#sbi_poly_response_form").serialize(),
                            })
                            .done(function(response) {
								...
								$.ajaxSetup({async:false});
								$.post( "sbiepay/response/upd_poly_merchant_no", { transaction_id: Object.assign({}, myarray) })
								 .done(function( data1 ) {
