        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="assessor_profile/add_other_job_role/document_upload">Document<br>Upload</a></li>
                    <!-- <li class="active"><a href="assessor_profile/add_other_job_role/edu_quali_indus_profe_exp">Qualifications & <br>Professional Experience</a></li> -->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php } elseif($this->input->method(TRUE) == "GET") { ?>
                            ...
                            <input type="radio" class="assessor_certified_status" name="certified" value="1" <?php echo $application_count[0]["certified_by_any_assessor"]  == 1 ? "checked" : ""; ?> <?php echo $disabled; ?> />  <span>Yes</span> &nbsp;
                            <input type="radio" class="assessor_certified_status" name="certified" value="0" <?php echo $application_count[0]["certified_by_any_assessor"]  != 1 ? "checked" : ""; ?> <?php echo $disabled; ?> />  <span>No</span>
                            <?php } else { ?>
                                <input type="radio" class="assessor_certified_status" name="certified" value="1" <?php echo $application_count[0]["certified_by_any_assessor"]  == 1 ? "checked" : ""; ?> <?php echo $disabled; ?> />  <span>Yes</span> &nbsp;
                            <input type="radio" class="assessor_certified_status" name="certified" value="0" <?php echo $asseapplication_countssor[0]["certified_by_any_assessor"]  != 1 ? "checked" : ""; ?> <?php echo $disabled; ?> />  <span>No</span>
                            <?php } ?>
                        <?php } ?>
                    </div>
                </div>
            ...
            <div class="agency_block" style="<?php echo $application_count[0]["certified_by_any_assessor"] == 1 ? "display: block;" : "display: none;" ?> ?>">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" name="highest_quali" id="highest_quali"  style="width: 100%;" tabindex="-1" aria-hidden="true" autocomplete="off" <?php echo $disabled; ?>> 
                            ...
                            <?php } elseif($this->input->method(TRUE) == "GET"){ ?>
                                <?php foreach($qualifications as $qualification){ ?>
                                <option value="<?php echo $qualification['qualification_id_pk'] ?>" <?php echo $application_count[0]['highest_qualification_id_pk'] == $qualification['qualification_id_pk'] ? "selected" : "" ?>  ?><?php echo $qualification['qualification'] ?></option>
                                <?php } ?>
                            <?php } ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php } elseif($this->input->method(TRUE) == "GET"){ ?>
                            <input type="text" value="<?php echo $application_count[0]['discipline'] ?>" name="discipline" id="discipline" class="form-control"  placeholder="Discipline" <?php echo $disabled; ?>>
                        <?php } ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php } elseif($this->input->method(TRUE) == "GET"){ ?>
                            <input type="text" value="<?php echo $application_count[0]['othert_quali'] ?>" name="othert_quali" id="othert_quali" class="form-control"  placeholder="Other Qualification" <?php echo $disabled; ?>>
                        <?php } ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" name="current_emp_status" id="current_emp_status" style="width: 100%;" tabindex="-1" aria-hidden="true" autocomplete="off" <?php echo $disabled; ?>>
                            ...
                            <?php } elseif($this->input->method(TRUE) == "GET"){ ?>
                                <?php foreach($employments as $employment){ ?>
                                <option value="<?php echo $employment['employment_status_id_pk'] ?>" <?php echo $application_count[0]['current_emp_status_id_fk'] == $employment['employment_status_id_pk'] ? "selected" : ""; ?>><?php echo $employment['employment_status'] ?></option>
                                <?php } ?>
                            <?php } ?>
                        </select>
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="assessor_profile/add_other_job_role/course" class="btn btn-primary btn-space confirm_pre">< Previous</a>
                    <a href="assessor_profile/add_other_job_role/work_experience" class="btn btn-primary btn-space confirm_next">Next > </a>
                </div>
                <?php if($application_count[0]['final_submission_status'] != 1){ ?>
