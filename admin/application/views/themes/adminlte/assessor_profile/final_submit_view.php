			...
			<div class="box-body box-profile">
				...
				?>
					...
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						...
						<li>
						<i class="fa <?php echo $app_data[0]['document_upload_flag'] == 't' ? 'fa-check bg-green' : 'fa-close bg-red'; ?>"></i>
						<div class="timeline-item">
							<h3 class="timeline-header"><a href="assessor_profile/assessor_registration/document_upload">Document Upload</a></h3>
						</div>
						</li>
						<li>
						...
						<li>
						<i class="fa <?php echo $app_data[0]['ssc_wbsctvesd_certified_flag'] == 't' ? 'fa-check bg-green' : 'fa-close bg-red'; ?>"></i>
						<div class="timeline-item">
							<h3 class="timeline-header"><a href="assessor_profile/assessor_registration/ssc_wbsctvesd_certified">SSC/ WBSCTVESD Certified</a> 
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
					...
					<?php if($app_data[0]['final_flag'] != 't'){ ?>
						<?php if($app_data[0]['basic_flag'] == 't' && $app_data[0]['course_flag'] == 't' && $app_data[0]['edu_qualification_flag'] == 't' && $app_data[0]['document_upload_flag'] == 't' && $app_data[0]['residential_address_flag'] == 't' && $app_data[0]['work_experience_flag'] == 't' && $app_data[0]['professional_details_flag'] == 't' && $app_data[0]['resume_photo_flag'] == 't' && $app_data[0]['ssc_wbsctvesd_certified_flag'] == 't'){ ?>
