        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="assessor_profile/add_other_job_role/assessor_experience">Assessor or <br>Expert Experience</a></li>
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="assessor_profile/add_other_job_role/work_experience" class="btn btn-primary btn-space confirm_pre"> < Previous</a>
                    <a href="assessor_profile/add_other_job_role/ssc_wbsctvesd_certified" class="btn btn-primary btn-space confirm_next">Next > </a>
                </div>
                <?php if($application_count[0]['final_submission_status'] != 1){ ?>
