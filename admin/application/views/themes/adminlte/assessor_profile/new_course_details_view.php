        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="assessor_profile/add_other_job_role/new_application_form">Course</a></li>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control apply_highest_quali select2 select2-hidden-accessible" name="apply_highest_quali" id="apply_highest_quali" style="width: 100%;" tabindex="-1" aria-hidden="true" autocomplete="off" <?php echo $disabled;?>>
                            ...
                            <?php } else { ?>
                                <?php foreach($qualifications as $qualification){ ?>
                                <option value="<?php echo $qualification['qualification_id_pk'] ?>" <?php echo $application_count[0]["apply_highest_quali"] == $qualification['qualification_id_pk'] ? "selected" : ""; ?>><?php echo $qualification['qualification'] ?></option>
                                <?php } ?>
                            <?php } ?>
                        </select>
                        ...
                        <select class="form-control domain_exp select2 select2-hidden-accessible" name="domain_exp" style="width: 100%;" tabindex="-1" aria-hidden="true" autocomplete="off" <?php echo $disabled;?>>
                            ...
                            <?php } else { ?>
                                <?php  if($assessor[0]["apply_highest_quali"] != NULL){ ?>
                                    <?php foreach($domain_experiances as $domain_experiance){ ?>
                                        <option value="<?php echo $domain_experiance['domain_specific_working_experience'] ?>" <?php echo $application_count[0]["domain_exp"] == $domain_experiance['domain_specific_working_experience'] ? "selected" : ""; ?>><?php echo $domain_experiance['domain_specific_working_experience'] ?></option>
                                    <?php } ?>
                                <?php }?>
                            <?php } ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control domain select2 select2-hidden-accessible" name="domain" style="width: 100%;" tabindex="-1" aria-hidden="true" autocomplete="off" <?php echo $disabled;?>>
                            ...
                            <?php } else { ?>
                                <?php foreach($domains as $domain){ ?>
                                <option value="<?php echo $domain['domain_id_pk'] ?>" <?php echo $application_count[0]["domain_id_fk"] == $domain['domain_id_pk'] ? "selected" : ""; ?>><?php echo $domain['domain_name'] ?></option>
                                <?php } ?>
                            <?php } ?>
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="assessor_profile/add_other_job_role/basic" class="btn btn-primary btn-space confirm_pre"> < Previous</a>
                    <a href="assessor_profile/add_other_job_role/edu_quali_indus_profe_exp" class="btn btn-primary btn-space confirm_next">Next > </a>
                </div>
                <?php if($application_count[0]['final_submission_status'] != 1){ ?>
