		...
		<div class="box-header with-border">
			...
			<div class="box-body box-profile">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-12">
					...
					<?php if($app_data[0]['basic_flag'] == 't' && $app_data[0]['course_flag'] == 't' && $app_data[0]['edu_qualification_flag'] == 't' && $app_data[0]['residential_address_flag'] == 't' && $app_data[0]['work_experience_flag'] == 't' && $app_data[0]['professional_details_flag'] == 't' && $app_data[0]['resume_photo_flag'] == 't' && $app_data[0]['ssc_wbsctvesd_certified_flag'] == 't'){ ?>
