                                ...
                                <?php foreach ($jobroleList as $key => $jobrole) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            [<?php echo $jobrole['jobroleDetails']['sector_code']; ?>]
                                        </td>
                                        <td>
                                            <?php echo $jobrole['jobroleDetails']['course_name']; ?>
                                            [<?php echo $jobrole['jobroleDetails']['course_code']; ?>]
                                        </td>
                                        <td><?php echo $jobrole['count']; ?></td>
                                        <td>
                                            <?php if ($jobrole['count'] > 0) { ?>
                                                <a href="<?php echo base_url('admin/cssvsebatch/batch/create?sid=' . md5($jobrole['jobroleDetails']['sector_id_pk']) . '&cid=' . md5($jobrole['jobroleDetails']['course_id_pk'])) ?>" class="btn btn-success btn-xs btn-flat">
                                                    Create Batch
                                                </a>
                                            <?php } ?>
                                        </td>
