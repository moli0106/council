        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?php echo base_url('admin/cssvsebatch/batch/jobrolelist') ?>" class="btn btn-success btn-sm btn-flat">
                            ...
                            <?php if (!empty($batchList)) { ?>
                                ...
                                <?php foreach ($batchList as $key => $batch) { ?>
                                    ...
                                    <tr id="<?php echo md5($batch['batch_id_pk']); ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/cssvsebatch/batch/details/' . md5($batch['batch_id_pk'])) ?>" class="btn bg-navy btn-block btn-xs btn-flat">
                                                <i class="fa fa-folder-open-o" aria-hidden="true"></i> Batch Details
                                            </a>
                                            <a href="<?php echo base_url('admin/cssvsebatch/batch/addInternalMarks/' . md5($batch['batch_id_pk'])) ?>" class="btn bg-blue btn-block btn-xs btn-flat">
