...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="cssvsebatch/batch/jobrolelist"><i class="fa fa-align-center"></i> Jobrole List</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <?php echo form_open_multipart('admin/cssvsebatch/batch/create?sid=' . md5($batchDetails['sector_id_fk']) . '&cid=' . md5($batchDetails['course_id_fk']), array('id' => 'create-batch-form')) ?>
                                <input type="hidden" name="school" class="form-control" value="<?php echo md5($batchDetails['school_id_fk']); ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="user-block">
                                                                ...
                                                                <span class="description"><?php echo $value['registration_number']; ?></span>
                                                            </div>
                                                        </td>
