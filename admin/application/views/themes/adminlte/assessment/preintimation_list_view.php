...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">List of Assessment Pre-Intimated Batch</h3>
                <div class="box-tools pull-right"></div>
            </div>
            <div class="box-body">
                    ...
                    <tbody style="font-size: 13px;">
                        ...
                        if (count($preintimation_list)) {
                            ...
                            foreach ($preintimation_list as $key => $preintimation) { ?>
                                ...
                                <tr id="<?php echo md5($preintimation['preintimation_assessment_id_pk']); ?>">
                                    <td><?php echo ++$i; ?>.</td>
                                    <td>
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <?php echo $preintimation['vertical_name']; ?>
                                            </li>
                                            <li class="list-group-item">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <?php echo $preintimation['tc_email']; ?>
                                                [ <?php echo $preintimation['tc_mobile_number']; ?> ]
                                            </li>
                                            <li class="list-group-item">
                                                <strong>TC State / District : </strong>
                                                <?php echo $preintimation['tc_state_name']; ?>
                                                [ <?php echo $preintimation['tc_district_name']; ?> ]
                                            </li>
                                        </ul>
                                    </td>
                                    <td>
