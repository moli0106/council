...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <?php echo form_open_multipart("admin/assessment/assessing/cssvsebatch/add_student/" . $batch_id_hash); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group <?php echo (form_error('dob') != '') ? 'has-error' : ''; ?>">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input class="form-control pull-left date-picker" id="std-datepicker" name="dob" placeholder="dd/mm/yyyy" readonly="true" value="<?php echo set_value('dob'); ?>">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group <?php echo (form_error('stdMobile') != '') ? 'has-error' : ''; ?>">
                                <label for="stdMobile">Mobile Number <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group <?php echo (form_error('stdEmail') != '') ? 'has-error' : ''; ?>">
                                <label for="stdEmail">Email Id <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group <?php echo (form_error('pinNo') != '') ? 'has-error' : ''; ?>">
                                <label for="pinNo">Pin Code <span class="text-danger">*</span></label>
                ...
                <div class="content-block">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group <?php echo (form_error('internal_marks') != '') ? 'has-error' : ''; ?>">
                                <label for="internal_marks">Internal Marks <span class="text-danger">*</span></label>
                                <input type="number" id="internal_marks" name="internal_marks" class="form-control" max="20" value="<?php echo set_value('internal_marks'); ?>">
                                <?php echo form_error('internal_marks'); ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group <?php echo (form_error('stdSector') != '') ? 'has-error' : ''; ?>">
                                ...
                                <input id="stdSector" name="stdSector" class="form-control" value="<?php echo $form_data['sector_name']; ?>" readonly>
                        ...
                        <div class="col-md-4">
                            <div class="form-group <?php echo (form_error('stdCourse') != '') ? 'has-error' : ''; ?>">
                                ...
                                <input id="stdCourse" name="stdCourse" class="form-control" value="<?php echo $form_data['course_name']; ?>" readonly>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <button id="submit" type="submit" value="submit" class="btn btn-info btn-block">Add Student to Batch</button>
                    </div>
                </div>
