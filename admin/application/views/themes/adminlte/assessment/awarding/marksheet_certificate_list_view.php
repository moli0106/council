...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-align-center"></i>Marksheet Certificate</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Marksheet & Certificate List</h3>
                        ...
                        <?php if (count($traineeList)) { ?>
                            ...
                            <?php foreach ($traineeList as $key => $trainee) { ?>
                                ...
                                <tr id="<?php echo md5($trainee['assessment_trainee_id_pk']); ?>">
                                    ...
                                    <td>
                                        <a target="_blank" href="<?php echo base_url('admin/assessment/awarding/batch/download_marksheet/' . md5($trainee['assessment_trainee_id_pk'])); ?>" class="btn btn-info btn-sm"><i class="fa fa-download"></i></a>
                                    </td>
                                    <td>
                                        <?php if ($trainee['exam_result'] == 1) { ?>
                                            <a target="_blank" href="<?php echo base_url('admin/assessment/awarding/batch/download_certificate/' . md5($trainee['assessment_trainee_id_pk'])); ?>" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a>
                                        <?php } ?>
                                    </td>
                                    <!-- <td>
                                        <label>
