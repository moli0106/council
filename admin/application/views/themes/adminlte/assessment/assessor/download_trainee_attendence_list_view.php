...
<table width="100%">
    <tr>
        <td width="50%" align="center" style="padding-top: 50px;">
            <p style="font-size: 15px;"><span style="font-weight: 900;">Signature for HOI</p>
            <p style="font-size: 15px;">(for CSS-VSE)</p>
        </td>
