<table width="100%">
    <tr>
        <td>
            <center>
                <!-- <img src="<?php echo base_url('admin/themes/adminlte/custom/council_logo.png'); ?>" width="80px"> -->
...
<table width="100%" border="1" cellspacing="0px" cellpadding="8px" style="font-size: 10px;">
    ...
    <tr style="background: #EEE">
        ...
        <td>
            <?php echo $batch_details['fname'] . ' ' . $batch_details['lname']; ?>
            [<?php echo $batch_details['assessor_code']; ?>]
        </td>
    </tr>
</table>
...
<table width="100%" border="1" cellspacing="0px" cellpadding="4px" style="font-size: 10px;">
    ...
    ?>
        <tr style="background: <?php echo $css; ?>;">
            ...
            <td>
                <?php if (!empty($tranee['tranee_marks'])) { ?>
                    <table width="100%" border="1" cellspacing="0px" cellpadding="4px" style="font-size: 10px; page-break-inside:avoid;">
                        ...
                        <tbody>
                            <?php $i = 0; ?>
                            <?php foreach ($tranee['tranee_marks'] as $key2 => $nos) { ?>
                                <tr>
                                    <td align="center"><?php echo ++$i; ?>.</td>
                                    <td><?php echo $nos['nos_name']; ?>/<?php echo $nos['nos_code']; ?></td>
                                    <td align="right"><?php echo ($nos['theory_marks'] != NULL) ? $nos['theory_marks'] : '--'; ?></td>
                                    <td align="right"><?php echo ($nos['practical_marks'] != NULL) ? $nos['practical_marks'] : '--'; ?></td>
                                    <td align="right"><?php echo ($nos['viva_marks'] != NULL) ? $nos['viva_marks'] : '--'; ?></td>
                                    <td align="right"><?php echo ($nos['total_marks'] != NULL) ? $nos['total_marks'] : '--'; ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
