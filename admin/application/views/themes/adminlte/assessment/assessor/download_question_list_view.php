            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="middle" align="center" width="20%" style="padding:10px;">
                        <!-- <img width="90" height="90" src="<?php echo base_url('themes/council_theme/councils/images/logoBig.png'); ?>"> -->
                            ...
                            <td align="left" valign="middle" style="font-family:nikosh; font-size:15px; padding-bottom:15px;">
                                ...
                                <span>
                                    ...
                                    <?php if (!empty($question['eng_questions'][0]['question_pic'])) {
                                        echo '<br><br>';
                                        echo '<img class="img-responsive" src="data:image/jpeg;base64,' . pg_unescape_bytea($question['eng_questions'][0]['question_pic']) . '">';
                                    } ?>
                                </span>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="690" style="font-family:nikosh; font-size:15px;">
                                                ...
                                                <?php if (!empty($question['eng_questions'][0]['option1_pic'])) { ?>
                                                    <img class="img-responsive" src="data:image/jpeg;base64,<?php echo pg_unescape_bytea($question['eng_questions'][0]['option1_pic']); ?>">
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="690" style="font-family:nikosh; font-size:15px;">
                                                ...
                                                <?php if (!empty($question['eng_questions'][0]['option2_pic'])) { ?>
                                                    <img class="img-responsive" src="data:image/jpeg;base64,<?php echo pg_unescape_bytea($question['eng_questions'][0]['option2_pic']); ?>">
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="690" style="font-family:nikosh; font-size:15px;">
                                                ...
                                                <?php if (!empty($question['eng_questions'][0]['option3_pic'])) { ?>
                                                    <img class="img-responsive" src="data:image/jpeg;base64,<?php echo pg_unescape_bytea($question['eng_questions'][0]['option3_pic']); ?>">
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="690" style="font-family:nikosh; font-size:15px;">
                                                ...
                                                <?php if (!empty($question['eng_questions'][0]['option4_pic'])) { ?>
                                                    <img class="img-responsive" src="data:image/jpeg;base64,<?php echo pg_unescape_bytea($question['eng_questions'][0]['option4_pic']); ?>">
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    </table>
