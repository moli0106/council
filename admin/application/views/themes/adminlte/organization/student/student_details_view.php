    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user-plus" aria-hidden="true"></i>Student Details</h3><br>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="salutation" id="salutation">
                                    ...
                                    <option value="<?php echo $salutation['salutation_id_pk'] ?>" <?php if($form_data['salutation'] == $salutation['salutation_id_pk']){echo 'selected';} ?>><?php echo $salutation['salutation_desc'] ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $form_data['fname']; ?>" name="fname" id="fname" class="form-control"  placeholder="First name">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $form_data['mname']; ?>" name="mname" id="mname" class="form-control"  placeholder="Middle name">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $form_data['lname']; ?>" name="lname" id="lname" class="form-control"  placeholder="Last name">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $form_data['mother_name']; ?>" name="mother_name" id="mother_name" class="form-control"  placeholder="Mother name">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $form_data['mob_no']; ?>" name="mob_no" id="mob_no" class="form-control"  placeholder="Mobile No." pattern="^[6-9]\d{9}$" title="Ten Digit Mobile No, Starting with 6 to 9">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="email" value="<?php echo $form_data['email_id']; ?>" name="email_id" id="email_id" class="form-control" placeholder="Email ID">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group date">
                                ...
                                <div class="common_input_div">
                                    <input type="text" value="<?php echo date('d/m/Y',strtotime($form_data['dob'])); ?>" class="form-control pull-right std-datepicker" id="dob" name="dob" placeholder="DD/MM/YYYY" autocomplete="off">
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="gender" id="gender">
                                    ...
                                    <option value="<?php echo $gender['gender_id_pk'] ?>" <?php if($form_data['gender'] == $gender['gender_id_pk']){echo 'selected';} ?>><?php echo $gender['gender_description'] ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="religion_id" id="religion_id">
                                    ...
                                    <option value="<?php echo $val['religion_id_pk'] ?>" <?php if($form_data['religion_id'] == $val['religion_id_pk']){echo 'selected';} ?>><?php echo $val['religion_name'] ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="reg_no" name="reg_no" class="form-control" type="text" value="<?php echo $form_data['reg_no']; ?>" placeholder="Registration No">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $form_data['street_vill_town']; ?>" name="address" id="address" class="form-control"  placeholder="Street/Village/Town">
                            ...
                            <div class="form-group">
                                ...
                                Upload Student Image 
                                    ...
                                    <?php if($form_data['image'] !='') {?>
                                        <a href="<?php echo base_url('admin/organization/student_reg/download_uploaded_doc/1/' . md5($form_data['student_details_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i>view</a>
                                    <?php }?>
                                </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                Upload Student Signature 
                                    ...
                                    <?php if($form_data['signature'] !='') {?>
                                        <a href="<?php echo base_url('admin/organization/student_reg/download_uploaded_doc/2/' . md5($form_data['student_details_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i>view</a>
                                    <?php }?>
                                </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                Upload Aadhar 
                                    ...
                                    <?php if($form_data['aadhar_doc'] !='') {?>
                                        <a href="<?php echo base_url('admin/organization/student_reg/download_uploaded_doc/3/' . md5($form_data['student_details_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i>view</a>
                                    <?php }?>
                                </label>
                    ...
                    <div class="row">
                                ...
                                <select name="stdCourse" id="stdCourse" class="form-control">
                                    ...
                                    <?php if (!empty($tc_course)) { ?>
                                        <?php foreach ($tc_course as $key => $value) { ?>
                                            <option value="<?php echo $value['course_id_fk']; ?>" <?php if ($form_data['course_id_fk'] == $value['course_id_fk']) echo 'selected'; ?>>
                                                <?php echo $value['course_name']; ?> [<?php echo $value['course_code']; ?>]
                                            </option>
                                        <?php } ?>
                                    <?php } else { ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group <?php echo (form_error('courseDuration') != '') ? 'has-error' : ''; ?>">
                                ...
                                <input type="text" name="courseDuration" id="courseDuration" class="form-control" value="<?php echo $form_data['course_duration']?>" readonly>
