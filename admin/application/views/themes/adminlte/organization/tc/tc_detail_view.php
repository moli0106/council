            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="tc_name" name="tc_name" class="form-control" type="text" placeholder="TC Name" value="<?php echo $form_data['tc_name']; ?>">
                ...
                <div class="content-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 other_state_div" <?php if (($form_data['state'] != 19)) echo 'style="display: none;"'; ?>>
