...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-align-center"></i> VTC Subject Details MIS</li>
        </ol>
    </section>
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">VTC Subject Details MIS</h3>
            </div>
            <div class="box-body">
...
<script>
    function ChangeHref(){
        ...
        document.getElementById("href_add").setAttribute("href", "mis/vtc_subject_details_mis/download_subject_details/"+academic_year);
    }
</script>
