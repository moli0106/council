...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-align-center"></i> Questions Format for Polytechnic</li>
        </ol>
    </section>
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">
                    ...
                    Questions Format of Polytechnic
                </h3>
                <div class="box-tools">
                    <a href="<?php echo base_url('admin/question_set_master/question_format/add'); ?>" class="btn btn-sm btn-block btn-flat btn-success">
                            ...
                            if (count($question_set_list)) {
                                ...
                                foreach ($question_set_list as $key => $question_set) { ?>
                                    ...
                                    <tr id="<?php echo md5($question_set['question_format_main_id_pk']); ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/question_set_master/question_format/details/' . md5($question_set['question_format_main_id_pk'])); ?>" class="btn btn-info btn-sm btn-flat">
                                                <i class="fa fa-folder-open" aria-hidden="true"></i>
                                            </a>
                                            <?php if ($question_set['question_set_status'] == 1) { ?>
                                            <a href="<?php echo base_url('admin/question_set_master/question_format/downloadQuestion/' . md5($question_set['question_format_main_id_pk'])); ?>" class="btn bg-navy btn-sm btn-flat">
