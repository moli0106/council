                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" value="<?php echo $form_data['mobile']; ?>" name="mob_no" id="mob_no" class="form-control"  placeholder="Mobile No.">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $form_data['email']; ?>" name="email_id" id="email_id" class="form-control" placeholder="Email ID">
                            ...
                            <div class="form-group">
                                ...
                                Upload Caste Document 
                                    ...
                                    <?php if($student_data['caste_doc'] !='') {?>
                                        <a href="<?php echo base_url('admin/vtc_student/student_reg/showCastedoc/' . md5($student_data['student_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                                    <?php }?>
                                </label>
                            ...
                            <div class="form-group">
                                ...
                                Upload P.C Certificate 
                                    ...
                                    <?php if($student_data['phy_challenged_doc'] !='') {?>
                                        <a href="<?php echo base_url('admin/vtc_student/student_reg/show_phy_challenged_doc/' . md5($student_data['student_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                                    <?php }?>
                                </label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group date">
                                ...
                                <div class="common_input_div">
                                    <input type="date" value="<?php echo date('d/m/Y',strtotime($student_data['date_of_birth'])); ?>" class="form-control pull-right datepicker" id="dob" name="dob" placeholder="DD/MM/YYYY" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                Upload Aadhar 
                                    ...
                                    <?php if($student_data['aadhar_doc'] !='') {?>
                                        <a href="<?php echo base_url('admin/vtc_student/student_reg/show_aadhar_doc/' . md5($student_data['student_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                                    <?php }?>
                                </label>
