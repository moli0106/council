...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <?php echo form_open_multipart("admin/vtc_student/student_reg/add_student"); ?>
                ...
                <div class="content-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" value="<?php echo set_value("mob_no"); ?>" name="mob_no" id="mob_no" class="form-control"  placeholder="Mobile No.">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 other_state_div" <?php if ((set_value('district') != 19)) echo 'style="display: none;"'; ?>>
