    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-user-plus" aria-hidden="true"></i> Update Student Details</h3>
                <div class="box-tools pull-right"></div>
            </div>

            <div class="box-body">
                <?php $std_id = md5($student_data['student_id_pk']); ?>
                <?php echo form_open_multipart("admin/vtc_student_admin/student_reg_admin/student_details/".$std_id); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="gender" id="gender">
                                    ...
                                    <option value="<?php echo $gender['gender_id_pk'] ?>" <?php if($form_data['gender_id_fk'] == $gender['gender_id_pk']){echo 'selected';} ?>><?php echo $gender['gender_description'] ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="course_name_id" id="course_name_id" value="<?php echo $form_data['class_id_fk'];?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="group_id" value="<?php echo $form_data['course_id_fk'];?>">
