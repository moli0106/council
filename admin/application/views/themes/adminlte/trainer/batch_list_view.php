                            ...
                            if(count($batchList))
                            {
                                ...
                                foreach ($batchList as $key => $batch) { ?>
                                    ...
                                    <tr id="<?php echo md5($batch['batch_ems_id_pk']); ?>">
                                        ...
                                        ?></td>
                                        <td><?php 
                                            echo ($batch['assment_mode'] == 1)?'Online':'Offline';
                                        ?></td>
                                        ...
                                        <td align="center">
											...
											<?php if($batch['training_link']==''){ ?>
												<a alt="<?php echo $offset ?>" href="<?php echo md5($batch['batch_ems_id_pk']) ?>" class="btn btn-success btn-sm send_training_link" data-toggle="modal" data-target="#myModal"><i class="fa fa-paper-plane" aria-hidden="true"></i></a>
											<?php }?>
                                        </td>
                                    </tr>
