                        ...
                        <div style="font-size: 13px;">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    ...
                                    <!-- <strong class="pull-right">VIII+ </strong> -->
                                    <strong class="pull-right"><?php echo $batchDetails['assessment_scheme_name']; ?> </strong>
                                </li>
                                <li class="list-group-item">
                                ...
                                <tbody>
                                    ...
                                    <?php if (count($stdList) > 0) { ?>
                                        <?php foreach ($stdList as $key => $value) { ?>
                                            <tr id="<?php echo md5($value['student_details_id_pk']); ?>">
