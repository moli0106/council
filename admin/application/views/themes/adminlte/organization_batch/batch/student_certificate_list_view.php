                                ...
                                <tr id="<?php echo md5($trainee['assessment_trainee_id_pk']); ?>">
                                    ...
                                    <td>
                                        <?php if ($trainee['exam_result'] == 1) { ?>
                                            <a target="_blank" href="<?php echo base_url('admin/organization_batch/batch/download_certificate/' . md5($trainee['assessment_trainee_id_pk'])); ?>" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a>
                                        <?php } ?>
                                    </td>
                                    <!-- <td>
                                        <label>
