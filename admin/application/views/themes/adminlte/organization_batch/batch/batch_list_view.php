        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <a href="<?php echo base_url('admin/organization_batch/batch/jobrolelist') ?>" class="btn btn-success btn-sm btn-flat">
                            ...
                            <?php if (!empty($batchList)) { ?>
                                ...
                                <?php foreach ($batchList as $key => $batch) { ?>
                                    ...
                                    <tr id="<?php echo md5($batch['batch_id_pk']); ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/organization_batch/batch/details/' . md5($batch['batch_id_pk'])) ?>" class="btn bg-navy btn-block btn-xs btn-flat">
                                            ...
                                            <?php if ($batch['process_id_fk'] == 15) { ?>
                                                <a href="<?php echo base_url('admin/organization_batch/batch/marksheet_certificate/' . md5($batch['user_batch_id'])); ?>" class="btn bg-maroon btn-xs btn-block">
