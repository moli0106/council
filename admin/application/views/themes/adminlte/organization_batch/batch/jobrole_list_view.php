                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($jobrole['count'] > 0) { ?>
                                                <a href="<?php echo base_url('admin/organization_batch/batch/create?sid=' . md5($jobrole['jobroleDetails']['sector_id_pk']) . '&cid=' . md5($jobrole['jobroleDetails']['course_id_pk'])) ?>" class="btn btn-success btn-xs btn-flat">
                                                    Create Batch
                                                </a>
                                            <?php } ?>
                                        </td>
