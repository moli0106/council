            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <div class="has-feedback">
                        <a  class="btn btn-info btn-sm btn-flat pay_vtc_std_exam_fee">Eligible to Exam Fee</a>
                    </div>
                    <input type="text" value="<?php echo count($std_list);?>" id="std_cnt">
                        ...
                        if (count($std_list)) {
                            ...
                            foreach ($std_list as $key => $val) { ?>
                                ...
                                <tr id="<?php echo md5($vtcDetails['vtc_id_pk']); ?>">
                                    <td>
                                        <?php if($val['eligible_for_exam']==1){?>
                                            <input type="checkbox" name="std_id_pk" class="checkStd" value=<?php echo $val['student_id_pk'] ?>>
                                        <?php }?>   
                                        <?php echo ++$i; ?>.
                                    </td>
                                    <td>
