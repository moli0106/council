        ...
        <div class="col-md-3">
            <div class="box box-info">
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b style="font-size: 12px;">Registration No.</b> <a style="font-size: 10px;" class="pull-right"><?php echo $studentDetails['registration_number']; ?></a>
                        </li>
                        <li class="list-group-item">
                            <b style="font-size: 12px;">Roll No.</b> <a style="font-size: 12px;" class="pull-right"><?php echo $studentDetails['roll_number']; ?></a>
                        </li>
                        <li class="list-group-item">
            ...
            <?php if (($studentDetails['nsqf_level'] == NULL) && ($studentDetails['batch_assigned_status'] == 0)) { ?>
                <div class="text-center">
                    <?php echo form_open("admin/vtc_student/student/remove_student", array("id" => "update-student-status")); ?>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content" style="height: 450px; overflow-y: scroll;" id="custom-scrollbar">
                    <div class="active tab-pane" id="studentInformation">
                        ...
                        <?php echo form_open_multipart("admin/vtc_student/student/update", array("id" => "update-student-info-form")); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <th><i class="fa fa-circle-o text-green"></i> Roll No.</th>
                                    <td>
                                        <div class="form-group">
                                            <input name="roll_number" class="form-control" value="<?php echo $studentDetails['roll_number'];; ?>" readonly>
                                        </div>
                                    </td>
                                    <th><i class="fa fa-circle-o text-green"></i> Aadher No.</th>
                                    <td>
                                        <div class="form-group">
                                            <input name="aadhar_no" class="form-control" value="<?php echo $studentDetails['aadhar_no']; ?>" maxlength="12">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input name="stdEmail" class="form-control" value="<?php echo ($studentDetails['email'] != NULL) ? $studentDetails['email'] : $school_data['vtc_email']; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <th><i class="fa fa-circle-o text-green"></i>District</th>
                                    <td>
                                        <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="form-group">
                                            <!-- added by Atreyee -->
                                             <input name="stdSector" type='hidden' class="form-control" value="<?php echo $studentDetails['sector_id_fk']; ?>">
                                             <!-- end -->
                                            <select name="stdSector" id="stdSector" class="form-control <?php echo (form_error('stdSector') != '') ? 'is-invalid' : ''; ?>" disabled>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="form-group">
                                            <!-- added by Atreyee -->
                                             <input name="stdCourse" id="stdCourse" type='hidden' class="form-control" value="<?php echo $studentDetails['course_id_fk']; ?>">
                                             <!-- end --> 
                                            <select name="stdCourse" id="stdCourse" class="form-control" disabled>
