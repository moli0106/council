                            ...
                            <tr>
                                ...
                                <td style="width: 13%; padding-top: 10px;">
                                    <?php if ($traineeDetails['trainee_image']) { ?>
                                        <img src="data:image/jpeg;base64,<?php echo $traineeDetails['trainee_image']; ?>" style="width:100px;height:130px;" />
                                    <?php } else { ?>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td valign="bottom" style="width:20%; border-bottom: 1px solid #000;">
                                    <strong><?php if($traineeDetails['assessment_scheme_id_fk']==2){ echo $traineeDetails['preferred_district_name']; } else{ echo $traineeDetails['tc_district_name'];}?></strong>
                                </td>
                    ...
                    <td style="padding-top: 10px;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
								...
								<?php if($traineeDetails['assessment_scheme_id_fk']!=3) { ?>
									<td rowspan="3" align="center" style="vertical-align:top;">
										<img src="<?php echo base_url() . '/' . 'admin/themes/adminlte/assets/image/certificate/ub.png'; ?>" style="width: 115px;">
									</td>
								<?php } ?>	
                                ...
                                <td align="center" style="font-size: 12px; width: 40%;" rowspan="3">
                                    ...
                                    <hr width="70%" style="margin-top: 2px;">
								...
								<td align="center" style="font-size: 12px; width: 40%;" rowspan="3">
                                    <img src="<?php echo $_SERVER['DOCUMENT_ROOT'] . '/' . 'admin/themes/adminlte/assets/image/certificate/logo.png'; ?>" style="width: 105px;">
                                    <br>
                                    <img src="<?php echo $_SERVER['DOCUMENT_ROOT'] . '/' . 'admin/themes/adminlte/assets/image/certificate/PurnanduBasu.png'; ?>" style="width: 130px;">
                                    <hr width="70%" style="margin-top: 2px;">
                                    <strong>Purnendu Basu</strong><br>
                            ...
                            <tr>
                                <td style="font-size: 10px;">
									...
									<<!-- img src="<?php echo base_url('admin/themes/adminlte/assets/image/certificate/qr-code.png'); ?>" style="width:50px;"> -->
                                    <img src="<?php echo $_SERVER['DOCUMENT_ROOT'].'/'.'admin/themes/adminlte/assets/image/certificate_council/qr-code.png'; ?>" width="150">
									<?php if($traineeDetails['assessment_scheme_id_fk']!=3) { ?>
                                    <br>
									<br>
									<br>
									...
									<br>
									<br>
									<br><strong>1.</strong> Training has been conducted under CSS-VSE,WB <br>
