                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <?php echo form_open_multipart('admin/vtc_student_batch/batch/create?sid=' . md5($batchDetails['sector_id_fk']) . '&cid=' . md5($batchDetails['course_id_fk']), array('id' => 'create-batch-form')) ?>
