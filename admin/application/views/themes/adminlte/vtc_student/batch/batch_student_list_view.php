                                        ...
                                        <tr id="<?php echo md5($value['student_id_pk']); ?>">
                                            ...
                                            <td>
                                                <?php if ($value['image'] != NULL) { ?>
                                                    <img class="profile-user-img img-responsive img-circle" src="data:image/jpeg;base64, <?php echo $value['image']; ?>" alt="Student Picture" style="width: 53px;">
                                                <?php } else { ?>
                                                    <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('admin/themes/adminlte/assets/image/user-profile.png'); ?>" alt="Student Picture" style="width: 53px;">
                                                <?php } ?>
                                            </td>
