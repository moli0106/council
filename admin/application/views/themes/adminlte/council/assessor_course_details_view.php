...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php echo form_open('admin/'. uri_string(), array('id'=>'assessor_course_details')); ?>
                        ...
                        <tbody id="courseListRow">
                            <?php $i = 1; foreach($jobroles as $jobrole) { ?>
                                <tr>
                                    ...
                                    <?php if(($jobrole['process_status_id_fk'] == NULL) || (in_array($this->session->stake_id_fk, array(2, 5)))){?>
                                        <td style="padding-left: 20px;;">
                                            <div class="radio text-success">
                                                <input id="radio1-<?php echo $i; ?>" name="radio[<?php echo md5($jobrole['assessor_registration_jobrole_sector_map_id_pk']); ?>]" type="radio" value="5" <?php echo ($jobrole['process_status_id_fk'] == 5) ? 'checked' : ''; ?>>
                                                <label for="radio1-<?php echo $i; ?>" class="radio-label">Accept</label>
                                            </div>

                                            <div class="radio text-danger">
                                                <input id="radio2-<?php echo $i; ?>" name="radio[<?php echo md5($jobrole['assessor_registration_jobrole_sector_map_id_pk']); ?>]" type="radio" value="6" <?php echo ($jobrole['process_status_id_fk'] == 6) ? 'checked' : ''; ?>>
            ...
            <?php } else { echo'<input id="ssc-404" name="" type="hidden" value="404">'; } ?>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <?php } elseif(in_array($this->session->stake_id_fk, array(2, 5)) && $assessor[0]['admin_level_one_approve_status'] == 0){
                    
                        echo'<button type="button" class="btn btn-info btn-block update-Information">Update Information</button>';
                    } ?>
                </div>
            </div>
