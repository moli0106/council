...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Status</th>
                            <?php if(($jobroles[0]['process_status_id_fk'] == NULL) || ($jobroles[0]['process_status_id_fk'] == 0) || (in_array($this->session->stake_id_fk, array(2, 5)))){?>
                            <th>Action</th>
                            <?php }?>
                        </tr>
                    </thead>
                    <tbody id="courseListRow">
                        ...
                        <tr>
                            ...
                            <td><?php echo $jobrole['process_status_id_fk'] == 0 ? "NA" : $jobrole['process_name']; ?>
                            </td>
                            <?php //echo validation_errors(); ?>

                            <?php if(($jobrole['process_status_id_fk'] == NULL) || ($jobroles[0]['process_status_id_fk'] == 0) || (in_array($this->session->stake_id_fk, array(2, 5)))){?>
        ...
        <?php } ?>
        <?php if($this->session->stake_id_fk == 5){  ?>
        ...
        <?php if($this->session->stake_id_fk == 5) {?>
			<?php if($assessor_appno[0]['process_status_id_fk']== 4) {?>
				<button type="submit" class="btn btn-primary pull-right">Submit</button>
			<?php }?>
        <?php } ?>
