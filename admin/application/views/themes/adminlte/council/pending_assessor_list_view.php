...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Pending Assessor List</h1>
        <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><i class="fa fa-align-center"></i> Pending Assessor List</li>
        </ol>
    </section>
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Pending Assessor List</h3>
            </div>
            <div class="box-body">
                <?php echo form_open('admin/council/pending_assessor_list',array('autocomplete'=> 'off')); ?>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4 pull-right">
                        <label for="inputtp">&nbsp;</label><br>
                        <a href="council/pending_assessor_list/excel_download"><button type="button" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button></a>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<?php echo md5($assessor['assessor_registration_details_pk']); ?>">
                            ...
                            <td>Application <?php echo $assessor['assessor_registration_application_no']; ?></td>
                            <td><?php echo date("d-m-Y", strtotime($assessor['final_submission_time'])); ?></td>
                            <td><?php echo $assessor['process_name'] != NULL ? $assessor['process_name'] : "NA" ?></td>
                            <!-- <td>
