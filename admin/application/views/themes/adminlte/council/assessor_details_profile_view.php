    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body print_details">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width:75%" colspan="3">
                                ...
                                <b>PAN No.: </b><?php echo $assessor[0]['pan'] ?> <a class="btn btn-primary btn-xs" href="assessor_profile/assessor_registration/download_pdf/pan/<?php echo md5($assessor[0]['assessor_registration_details_pk']); ?>">Download</a><br>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-xs" href="assessor_profile/assessor_registration/download_pdf/ascer/<?php echo md5($certificate['council_assessor_registration_certified_map_id_pk']); ?>">Download</a></td>
                            </tr>
                            <?php $i++; } ?>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-xs" href="assessor_profile/assessor_registration/download_pdf/wex/<?php echo md5($get_work_exp['assessor_work_experience_id_pk']); ?>">Download</a></td>
                            </tr>
                            <?php $i++; } ?>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-xs" href="assessor_profile/assessor_registration/download_pdf/eaaesc/<?php echo md5($get_assessor_expert['assessor_registration_assessor_expert_map_id_pk']); ?>">Download</a></td>
                            </tr>
                            <?php $i++; } ?>
                        </tbody>
                    </table>
                ...
                <?php if(!count($wbsctvesed_certificates)){ ?>
                    <table class="table table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a class="btn btn-primary btn-xs" href="assessor_profile/assessor_registration/download_pdf/ssc_wbsctvesd_certified/<?php echo md5($assessor[0]['assessor_registration_details_pk']); ?>">Download</a></td>
                                <?php }else{?>
                                    <td>N/A</td>
                                    <?php }?>
                            </tr>
                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    <tbody>
                    <?php $i = 1; foreach($wbsctvesed_certificates as $certificate) { ?>
                        <tr>
                            <td><?php echo $i ;?></td>
