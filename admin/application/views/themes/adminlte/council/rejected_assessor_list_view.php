...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Rejacted Assessor List</h1>
        <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><i class="fa fa-align-center"></i> Rejacted Assessor List</li>
        </ol>
    </section>
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Rejacted Assessor List</h3>
            </div>
            <div class="box-body">
                <?php echo form_open('admin/council/rejected_assessor_list',array('autocomplete'=> 'off')); ?>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4 pull-right">
                        <label for="inputtp">&nbsp;</label><br>
                        <a href="council/rejected_assessor_list/excel_download"><button type="button" class="btn btn-success"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button></a>
                    </div>
                </div>
