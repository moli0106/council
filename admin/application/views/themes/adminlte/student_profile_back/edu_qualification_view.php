        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
               ...
               <!--  <h4>Particulars of the last Examination Passed</h4> -->
                ...
                <div class="row" <?php if($app_data['exam_type_id_fk'] == 3) {echo 'style="display: block;"';} else{echo 'style="display: none;"';}?>>
                    <!--div class="col-md-3">
                        <div class="form-group">
            ...
            <div class="box-footer">
                <div class="btn-group">
                <a href="student_profile/std_registration/photo_signature" class="btn btn-primary btn-space confirm_pre">
                        < Previous</a>
                    <a href="student_profile/std_registration/final_submit" class="btn btn-primary btn-space confirm_next">Next >
                    </a>
                </div>
