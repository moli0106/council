        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="" for="poly_course_id">Course name <span
                                    class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="<?php echo $app_data['discipline_name'];?>" readonly>
					...
					<div class="col-md-4">
                        <div class="form-group">
                            <label class="" for="exam_type_id">Select Exam/Application name <span
                                    class="text-danger">*</span></label>
                            <select class="form-control" name="exam_type_id" id="exam_type_id" disabled>
                                <option value="" hidden="true">Select course name</option>
                                <?php foreach ($exam_type as $value) { ?>
                                    <option value="<?php echo $value['exam_type_id_pk']?>" <?php if($value['exam_type_id_pk'] == $app_data['exam_type_id_fk']){echo 'selected';}?>><?php echo $value['name_for_std_reg']?></option>
                                <?php }?>
