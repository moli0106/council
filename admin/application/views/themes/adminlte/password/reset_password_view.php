...
<div class="login_box">
    ...
    <div class="login-body">
		...
		<?php if($login_id) { ?>
			...
			<?php echo form_open('admin/password/reset_password/'.$login_id.'/'.$id_hash,array('class' => 'login_form','name' => 'reset_password', 'id' => 'reset_password','autocomplete'=>'off')); ?>
			
				<div class="form-group has-feedback">
					<input type="password" class="form-control" name="new_password" value="<?php echo set_value('new_password'); ?>" placeholder="Enter new password">
					<span class="fa fa-lock form-control-feedback"></span>
					<?php echo form_error('new_password'); ?>
				</div>

				<div class="form-group has-feedback">
					<input type="password" class="form-control" name="confirm_password" value="<?php echo set_value('confirm_password'); ?>" placeholder="Confirm your password">
					<span class="fa fa-lock form-control-feedback"></span>
		...
		<?php } else { ?>
			<p class="">Please check your mail. we have sent you password reset email.</p>
		<?php } ?>
