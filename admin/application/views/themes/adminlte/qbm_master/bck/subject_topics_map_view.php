            ...
            <div class="col-md-6">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <strong><i class="fa fa-file-text-o margin-r-5"></i> Course name:</strong>
                        <p class="text-muted pull-right"><?php echo $subject["course_name"] ?></p>

                        <hr>

                        <strong><i class="fa fa-file-text-o margin-r-5"></i> Discipline [Code]:</strong>
                        <p class="text-muted pull-right"><?php echo $subject['discipline_name']; ?> <b>[<?php echo $subject['discipline_code']; ?>]<b></p>

                        <hr>

                        <strong><i class="fa fa-file-text-o margin-r-5"></i> Group/Trade [Code]:</strong>
                        <p class="text-muted pull-right"><?php if($subject['group_trade_name']!=''){?><?php echo $subject['group_trade_name']; ?> <b>[<?php echo $subject['group_trade_code']; ?>]<b><?php }else{echo 'N/A';}?></p>

                        <hr>

                        <strong><i class="fa fa-file-text-o margin-r-5"></i> Subject Group:</strong>
                        <p class="text-muted pull-right"><?php if($subject['subject_group_name']!=''){?><?php echo $subject['subject_group_name']; ?><?php }else{echo 'N/A';}?></p>

                        <hr>

                        <strong><i class="fa fa-file-text-o margin-r-5"></i> Semester/Year:</strong>
                        <p class="text-muted pull-right"><?php if($subject['semester_name']!=''){?><?php echo $subject['semester_name']; ?><?php }else{echo 'N/A';}?></p>

                        <hr>

                        <strong><i class="fa fa-file-text-o margin-r-5"></i> Subject [Code]:</strong>
                        <p class="text-muted pull-right"><?php echo $subject['subject_name']; ?> <b>[<?php echo $subject['subject_code']; ?>]</p>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<?=$topics_chapter['subject_topics_map_id_pk']?>">
                            ...
                            <td>
                            <?php if($subject["course_id_fk"]==1 || $subject["course_id_fk"]==2){?>
                                <?php echo $topics_chapter['semester_name'];?>
                            <?php } else{?>
                                <?php echo $topics_chapter['poly_semester_name'];?>
                                <?php }?>
                            </td>
