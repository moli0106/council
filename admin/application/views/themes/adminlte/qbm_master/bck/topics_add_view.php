...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Topics/Chapter</h1>
        <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><i class="fa fa-align-center"></i>Topics/Chapter Add</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Topics/Chapter Add</h3>
            </div>
            <div class="box-body">
                <?php echo form_open('admin/qbm_master/topics/add') ?>
                    ...
                    <div class="row">        
                        <div class="hsvoc_hide_show" style="<?php echo $hide_show;?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="" for="">Subject Group *</label>
