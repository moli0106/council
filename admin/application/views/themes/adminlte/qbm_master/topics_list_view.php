...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Topics/Chapter List</h1>
        <ol class="breadcrumb">
            <li><a href="dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active"><i class="fa fa-align-center"></i>Topics/Chapter List</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Topics/Chapter List</h3>
                <div class="box-tools pull-right">
                    <a href="<?php echo base_url('admin/qbm_master/topics/add') ?>" class="btn btn-info btn-sm">
                        <i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Add Topics/Chapter
                    </a>
                </div>
            </div>
            <div class="box-body">
                            ...
                            if(count($subjectList))
                            {
                                ...
                                foreach ($subjectList as $key => $subject) { ?>
                                    ...
                                    <tr id="<?php echo md5($subject['subject_id_pk']); ?>">
                                        ...
                                        <td><?php echo $subject['subject_group_name']; ?></td>
