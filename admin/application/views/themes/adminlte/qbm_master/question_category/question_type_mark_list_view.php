            ...
            <div class="col-md-3">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Category/Type Marks</h3>
                    </div>
                    <div class="box-body">
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="" for="">Question Category/Type List <span class="text-danger">*<span></label>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Category/Type Marks List</h3>
                        ...
                        <table class="table table-hover">
                            ...
                            if (count($subjectMapCategoryList)) {
                                ...
                                foreach ($subjectMapCategoryList as $key => $subjectMapCategory) { ?>
                                    ...
                                    <tr id="<?php echo ($subjectMapCategory['subject_question_type_mark_map_id_pk']); ?>">
                                        <td><?php echo ++$i; ?>.</td>
										...
										<td><?php echo $subjectMapCategory['semester_name']; ?></td>
