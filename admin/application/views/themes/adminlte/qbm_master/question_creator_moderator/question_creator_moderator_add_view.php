...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <?php echo form_open('admin/qbm_master/question_creator_moderator/add') ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 sector-id" style="width: 100%;" name="creator_moderator_type">
                                    ...
                                    <option value="19" <?php echo set_select('creator_moderator_type', 19) ?>>Question Creator</option>
                                    <option value="20" <?php echo set_select('creator_moderator_type', 20) ?>>Question Moderator</option>
                                </select>
