        ...
        <div class="box box-success">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <?php if($this->session->userdata('stake_id_fk')==19){?>
                                ...
                                <?php foreach ($questionList as $key => $value) { ?>
                                    ...
                                    <tr id="<?php echo md5($value['question_id_pk']); ?>">
                                        ...
                                        <td style="width: 13%;">
                                            ...
                                            <button class="btn <?php echo $mati_btn_color;?> btn-xs btn-flat add-multi-lang-question" data-toggle="modal" data-target="#modal-question-details">Multi Lang.</button>
