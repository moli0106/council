...
<?php echo form_open_multipart("admin/qbm/questions_qt/updateEngQuestion/" . md5($question_details[0]['question_id_pk'])); ?>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?php if ($question['question_pic'] != NULL) { ?>
                        <a href="<?php echo base_url('admin/qbm/questions_qt/eng_question_image/' . md5($question['eng_question_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                    <?php } else { ?>
...
<!-- Add By Moli on 24-02-2022 -->
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?php if ($question['answer_pic'] != NULL) { ?>
                        <a href="<?php echo base_url('admin/qbm/questions_qt/eng_question_clue_image/' . md5($question['eng_question_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                    <?php } else { ?>
                        <span class="text-danger"><i>No image found...</i></span>
                    <?php } ?>
                </div>
            ...
            <div class="col-md-4">
                ...
                <a href="<?php echo base_url('admin/qbm/questions_qt/eng_question_image_transfer/' . md5($question['eng_question_id_pk'])); ?>"  class="btn btn-flat btn-sm btn-info"><i class="fa fa-exchange" aria-hidden="true"></i></a>
            </div>
            <!-- Added By Moli -->
...
<div class="row" style="margin-top: 30px; margin-bottom: 30px;">
    <div class="col-md-4 col-md-offset-4">
        <button type="submit" class="btn btn-warning btn-block btn-flat" id="submit-multi-lang-question">Update Question</button>
    </div>
</div>
