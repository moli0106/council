...
<?php echo form_open_multipart("admin/qbm/questions/updateEngQuestion/" . md5($question_details[0]['question_id_pk'])); ?>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?php if ($question['answer_pic'] != NULL) { ?>
                        <a href="<?php echo base_url('admin/qbm/questions/eng_question_clue_image/' . md5($question['eng_question_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                    <?php } else { ?>
                        <span class="text-danger"><i>No image found...</i></span>
                    <?php } ?>
                </div>
