...
<?php echo form_open_multipart("admin/qbm/questions/addMultiLangQuestion/" . md5($question_details[0]['question_id_pk'])); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php if ($question['answer_pic'] != NULL) { ?>
                            <a href="<?php echo base_url('admin/qbm/questions/other_question_clue_image/' . md5($other_question_details[$key]['other_question_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                        <?php } else { ?>
                            <span class="text-danger"><i>No image found...</i></span>
                        <?php } ?>
                    </div>
