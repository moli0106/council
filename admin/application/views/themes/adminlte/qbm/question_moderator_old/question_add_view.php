...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <?php echo form_open_multipart("admin/qbm/questions_qm/create"); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="subject_topics_id" id="subject_topics_id">
                                ...
                                <?php foreach ($topic_list as $topic) { ?>
                                    <?php if ($this->input->method(TRUE) == "POST") { ?>
                                        <option value="<?php echo $topic['subject_topics_map_id_pk']; ?>" <?php echo set_select('subject_topics_id', $topic['subject_topics_map_id_pk']); ?>><?php echo $topic['topics_chapter_name']; ?></option>
                                <?php }
                                } ?>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" style="width: 100%;" name="question_type_marks" id="question_type_marks">
                                ...
                                <option value="" disabled="true">Select Subject First...</option>
                            </select>
                    ...
                    <div class="question-box">
                        <div class="row question-box-row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="" for="">Question Marks <span class="text-danger">*<span></label>
                                    <input type="number" class="form-control per-question-marks required" name="per_question_marks[]">
                                    <?php echo form_error('per_question_marks'); ?>
                                </div>
                            </div>
                        </div>
