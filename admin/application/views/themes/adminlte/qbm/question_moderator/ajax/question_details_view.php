    ...
    <div class="question-box">
        <div class="row question-box-row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?php if ($question['answer_pic'] != NULL) { ?>
                        <a href="<?php echo base_url('admin/qbm/questions_qm/eng_question_clue_image/' . md5($question['eng_question_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                    <?php } else { ?>
                        <span class="text-danger"><i>No image found...</i></span>
                    <?php } ?>
                </div>
            ...
            <div class="col-md-4">
                ...
                <a href="<?php echo base_url('admin/qbm/questions_qm/eng_question_image_transfer/' . md5($question['eng_question_id_pk'])); ?>"  class="btn btn-flat btn-sm btn-info"><i class="fa fa-exchange" aria-hidden="true"></i></a>
            </div>
            <!-- Added By Moli on 23-02-2022 -->
