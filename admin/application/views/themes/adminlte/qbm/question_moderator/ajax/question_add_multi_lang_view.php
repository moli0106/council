...
<?php foreach ($question_details as $key => $question) { ?>
    ...
    <div class="question-box">
        <div class="row question-box-row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php if ($question['question_pic'] != NULL) { ?>
                            <a href="<?php echo base_url('admin/qbm/questions_qm/other_question_image/' . md5($other_question_details[$key]['other_question_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                        <?php } else { ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php if ($question['answer_pic'] != NULL) { ?>
                            <a href="<?php echo base_url('admin/qbm/questions_qm/other_question_clue_image/' . md5($other_question_details[$key]['other_question_id_pk'])); ?>" target="_blank" class="btn btn-flat btn-sm btn-success"><i class="fa fa-download" aria-hidden="true"></i></a>
                        <?php } else { ?>
                            <span class="text-danger"><i>No image found...</i></span>
                        <?php } ?>
                    </div>
			...
			<!-- Added By Moli on 23-02-2022 -->
			<?php if (!empty($other_question_details)) { ?>
            <div class="col-md-4">
                <label class="" for="">Image Transfer (Question Image to Clue Image)</label><br>
            
                <a href="<?php echo base_url('admin/qbm/questions_qm/other_question_image_transfer/' . md5($other_question_details[$key]['other_question_id_pk'])); ?>"  class="btn btn-flat btn-sm btn-info"><i class="fa fa-exchange" aria-hidden="true"></i></a>
            </div>
			<?php }?>
            <!-- Added By Moli on 23-02-2022 -->
        </div>
