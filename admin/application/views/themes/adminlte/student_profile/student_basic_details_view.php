    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $app_data['first_name']; ?>" placeholder="Enter First name" pattern="[a-zA-Z]+" title="Please enter on alphabets only" />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="fname" name="fname" value="<?php echo set_value('fname') ?>" placeholder="Enter First name" pattern="[a-zA-Z]+" title="Please enter on alphabets only" />
                            <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="mname" name="mname" value="<?php echo $app_data['middle_name']; ?>" placeholder="Enter Middle name" pattern="[a-zA-Z]+" title="Please enter on alphabets only"/>
                            <?php } else { ?>
                                <input type="text" class="form-control" id="mname" name="mname" value="<?php echo set_value('mname') ?>" placeholder="Enter Middle name" pattern="[a-zA-Z]+" title="Please enter on alphabets only"/>
                            <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="lname" name="lname" value="<?php echo $app_data['last_name']; ?>" placeholder="Enter Last name" pattern="[a-zA-Z]+" title="Please enter on alphabets only"/>
                            <?php } else { ?>
                                <input type="text" class="form-control" id="lname" name="lname" value="<?php echo set_value('lname') ?>" placeholder="Enter Last name" pattern="[a-zA-Z]+" title="Please enter on alphabets only"/>
                            <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="father_name" name="father_name" value="<?php echo $app_data['father_name']; ?>" placeholder="Enter Father name" pattern="[a-zA-Z ]+" title="Please enter on alphabets only"/>
                            <?php } else { ?>
                                <input type="text" class="form-control" id="father_name" name="father_name" value="<?php echo set_value('father_name') ?>" placeholder="Enter Father name" pattern="[a-zA-Z ]+" title="Please enter on alphabets only"/>
                            <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="mother_name" name="mother_name" value="<?php echo $app_data['mothers_name']; ?>" placeholder="Enter Mother name" pattern="[a-zA-Z ]+" title="Please enter on alphabets only"/>
                            <?php } else { ?>
                                <input type="text" class="form-control" id="mother_name" name="mother_name" value="<?php echo set_value('mother_name') ?>" placeholder="Enter Mother name" pattern="[a-zA-Z ]+" title="Please enter on alphabets only"/>
                            <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="guardian_name" name="guardian_name" value="<?php echo $app_data['guardian_name']; ?>" placeholder="Enter Guardian name" pattern="[a-zA-Z ]+" title="Please enter on alphabets only"/>
                            <?php } else { ?>
                                <input type="text" class="form-control" id="guardian_name" name="guardian_name" value="<?php echo set_value('guardian_name') ?>" placeholder="Enter Guardian Name" pattern="[a-zA-Z ]+" title="Please enter on alphabets only"/>
                            <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="citizenship" id="citizenship">
                                ...
                                <?php foreach ($nationality as $key => $value) { ?>
                                    ...
                                    <?php } else { ?>
                                        <option value="<?php echo $value['nationality_id_pk']; ?>" <?php echo set_select('citizenship', $value['nationality_id_pk']); ?>><?php $value['nationality_name'] ?></option>
                                    <?php } ?>
                    ...
                    <div class="col-md-4 citizenship_doc_div" <?php if (($formData['citizenship'] == 1) || ($formData['citizenship'] == NULL)) echo 'style="display: none;"'; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <small><a target="_blank"href="student_profile/std_registration/download_citizenship_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 caste_doc_div" <?php if (($formData['caste_id'] == 1) || ($formData['caste_id'] == NULL)) echo 'style="display: none;"'; ?>>
                        ...
                        <small><a target="_blank"href="student_profile/std_registration/download_caste_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
                    ...
                    <div class="col-md-4 phy_challenged_doc_div" <?php if (($formData['phy_challenged'] == 0) || ($formData['phy_challenged'] == NULL)){ echo 'style="display: none;"';} ?>>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($app_data['phy_challenged_doc'] !='') {?>
                                ...
                                <small><a target="_blank"href="student_profile/std_registration/download_handicap_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
                            <div class="input-group">
                                <label class="input-group-btn">
                                    <span class="btn btn-success">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group date">
                            ...
                            <div class="common_input_div">
                                <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                    <input type="text" class="form-control datepicker" id="dob" name="dob" value="<?php if($app_data['date_of_birth']!=''){echo date('d-m-Y', strtotime($app_data['date_of_birth']));} ?>" placeholder="DD-MM-YYYY" readonly />
                                <?php } else { ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <?php if($app_data['aadhar_doc'] !='') {?>
                                ...
                                <small><a target="_blank"href="student_profile/std_registration/download_aadhaar_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="student_profile/std_registration" class="btn btn-primary btn-space confirm_pre">
                        < Previous</a>
                            <a href="student_profile/std_registration/photo_signature" class="btn btn-primary btn-space confirm_next">Next >
                            </a>
                </div>
