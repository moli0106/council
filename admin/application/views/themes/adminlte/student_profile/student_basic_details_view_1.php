...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php if (($formData['gender_id_fk'] == 1 && $formData['marital_status'] == 1) || ($formData['gender_id_fk'] == 1 && $formData['marital_status'] == 2) || ($formData['gender_id_fk'] == 2 && $formData['marital_status'] == 1)) {
            $kanyas_view = '';
        } else {
            $kanyas_view = 'block';
        } ?>
