    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <h4>Photo & Signature</h4><hr>
                <div class="row">

                <div class="col-md-4">
                    <div class="form-group ">
                        <label>Upload Signatude <span class="text-danger">*</span> (JPEG format between 100KB. Dimensions 250x320 pixels preferred)</label>
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="student_profile/std_registration/basic_details" class="btn btn-primary btn-space confirm_pre"> < Previous</a>
