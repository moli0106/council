					...
					<div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="course_level" id="course_level"
                                value="<?php echo set_value('course_level'); ?>" placeholder="Enter course level">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action_buttons">
                                ...
                                <a href="master/new_course/map_domain_qualification/<?php echo md5($course['course_id_pk']) ?>" alt="" class="btn btn-xs btn-info">Map Domain & Exp</a>
                            </td>
                        </tr>
