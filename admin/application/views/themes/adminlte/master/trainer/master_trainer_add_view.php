...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-align-center"></i>Master Trainer Add</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Master Trainer Add</h3>
            </div>
            <div class="box-body">
                <?php echo form_open('admin/master/master_trainer/add', array('id'=>'masterTrainerForm')) ?>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <select class="form-control sector-id" style="width: 100%;" name="sector_id[]">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label class="" for="">Job Role *</label>
                                <select class="form-control job_role_id" style="width: 100%;" name="course_id[]">
                        ...
                        <div class="col-md-2">
                            <div class="form-group" style="text-align: center;">
                                ...
                                <button type="button" class="btn btn-success btn-sm btn-add"><i class="fa fa-plus" aria-hidden="true"></i></button>
                            </div>
                        </div>
                    </div>
					<div id="dynamicForm">
