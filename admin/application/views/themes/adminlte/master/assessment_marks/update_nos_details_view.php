        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter NoS Total Theory Marks" step=".01" name="nos_theory_marks" id="nos_theory_marks" value="<?php echo $nos_details['nos_theory_marks']; ?>" min="0">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter NoS Total Practical Marks" step=".01" name="nos_practical_marks" id="nos_practical_marks" value="<?php echo $nos_details['nos_practical_marks']; ?>" min="0">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter NoS Viva Marks" step=".01" name="nos_viva_marks" id="nos_viva_marks" value="<?php echo $nos_details['nos_viva_marks']; ?>" min="0">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter NoS Theory Pass Marks" step=".01" name="theory_pass_marks" id="theory_pass_marks" value="<?php echo $nos_details['theory_pass_marks']; ?>" min="0">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter NoS Practical Pass Marks" step=".01" name="practical_pass_marks" id="practical_pass_marks" value="<?php echo $nos_details['practical_pass_marks']; ?>" min="0">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter NoS Viva Pass Marks" step=".01" name="viva_pass_marks" id="viva_pass_marks" value="<?php echo $nos_details['viva_pass_marks']; ?>" min="0">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter NoS Practical Pass Marks" step=".01" name="nos_wise_no_of_theory_question" id="nos_wise_no_of_theory_question" value="<?php echo $nos_details['nos_wise_no_of_theory_question']; ?>" min="1">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter No. of marks each Question carries" step=".01" name="no_of_marks_each_question_carries" id="no_of_marks_each_question_carries" value="<?php echo $nos_details['no_of_marks_each_question_carries']; ?>" min="0">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter Total Pass Marks for Each NOS" step=".01" name="pass_marks_for_each_nos" id="pass_marks_for_each_nos" value="<?php echo $nos_details['pass_marks_for_each_nos']; ?>" min="0">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Enter Total Pass Marks for the Job Role" step=".01" name="total_marks_for_job_role" id="total_marks_for_job_role" value="<?php echo $nos_details['total_marks']; ?>" readonly="true">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="pass_marks_for_job_role">Total Pass Marks for Job Role (QP)<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" placeholder="Enter Total Pass Marks for the Job Role" step=".01" name="pass_marks_for_job_role" id="pass_marks_for_job_role" value="<?php echo $nos_details['total_pass_marks']; ?>" min="0">
