                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter Total Pass Marks for the Job Role" name="total_marks_for_job_role" id="total_marks_for_job_role" value="<?php echo $form_input['total_marks']; ?>" readonly="true">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="pass_marks_for_job_role">Total Pass Marks for Job Role (QP)<span class="text-danger">*</span></label>
                            <input type="number" class="form-control" placeholder="Enter Total Pass Marks for the Job Role" name="pass_marks_for_job_role" id="pass_marks_for_job_role" value="<?php echo $form_input['pass_marks']; ?>" min="1">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="radio">
                                ...
                                <label><input type="radio" name="pass_in_every_nos" value="No" <?php if ($form_input['pass_in_nos'] == 'No') echo 'checked'; ?>>No</label>
