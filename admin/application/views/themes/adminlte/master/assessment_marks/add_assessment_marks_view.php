                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter NoS Total Theory Marks" name="nos_theory_marks" id="nos_theory_marks" value="<?php echo set_value('nos_theory_marks'); ?>" min="0">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter NoS Total Practical Marks" name="nos_practical_marks" id="nos_practical_marks" value="<?php echo set_value('nos_practical_marks'); ?>" min="0">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter NoS Theory Pass Marks" name="theory_pass_marks" id="theory_pass_marks" value="<?php echo set_value('theory_pass_marks'); ?>" min="0">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter NoS Practical Pass Marks" name="practical_pass_marks" id="practical_pass_marks" value="<?php echo set_value('practical_pass_marks'); ?>" min="0">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter Total Pass Marks for the Job Role" name="pass_marks_for_job_role" id="pass_marks_for_job_role" value="<?php echo set_value('pass_marks_for_job_role'); ?>" min="0">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter NoS Practical Pass Marks" name="nos_wise_no_of_theory_question" id="nos_wise_no_of_theory_question" value="<?php echo set_value('nos_wise_no_of_theory_question'); ?>" min="0">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Enter No. of marks each Question carries" name="no_of_marks_each_question_carries" id="no_of_marks_each_question_carries" value="<?php echo set_value('no_of_marks_each_question_carries'); ?>" min="0">
