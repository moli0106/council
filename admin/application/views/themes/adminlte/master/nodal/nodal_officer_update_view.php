    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">Nodal Officer Update</h3>
            </div>
            <div class="box-body">
                <?php echo form_open('admin/master/nodal/update/' . md5($nodalOfficer['nodal_officer_id_pk'])) ?>
                <div class="row">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="district_id" id="district_id">
                                        ...
                                        <?php foreach ($districtList as $district) { ?>
                                            <option value="<?php echo $district['district_id_pk'] ?>" <?php if ($formData['district_id'] == $district['district_id_pk']) echo "selected"; ?>>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nodal_centre_name" id="nodal_centre_name" placeholder="Enter Nodal Centre Name" value="<?php echo $formData['nodal_centre_name']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nodal_centre_email" id="nodal_centre_email" placeholder="Enter Nodal Center Email" value="<?php echo $formData['nodal_centre_email']; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nodal_officer_mobile" id="nodal_officer_mobile" placeholder="Enter Nodal Officer Mobile" value="<?php echo $formData['nodal_officer_mobile']; ?>">
