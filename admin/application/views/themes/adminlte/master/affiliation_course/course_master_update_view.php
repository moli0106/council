...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <?php echo form_open('admin/master/affiliation_course/update/' . md5($courseMaster['affiliation_course_master_id_pk'])) ?>
                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="group_name" id="group_name">
                                        ...
                                        <?php foreach ($groupList as $groupName) { ?>
                                            <option value="<?php echo $groupName['group_id_pk'] ?>" <?php if ($formData['group_name'] == $groupName['group_id_pk']) echo "selected"; ?>>
                            ...
                            <div class="col-md-6 class-div" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="class_name" id="class_name">
                                        ...
                                        <option value="1" <?php if ($formData['class_name'] == 1) echo "selected"; ?>>class-XI</option>
                                        <option value="2" <?php if ($formData['class_name'] == 2) echo "selected"; ?>>class-XII</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category_id" id="category_id">
                                        ...
                                        <?php foreach ($subjectCategory as $subject) { ?>
                                            <option value="<?php echo $subject['subject_category_id_pk'] ?>" <?php if ($formData['subject_category_id_fk'] == $subject['subject_category_id_pk']) echo "selected"; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="subject_name_id" id="subject_name_id">
                                        ...
                                        <?php foreach ($subjectList as $subject) { ?>
                                            <option value="<?php echo $subject['subject_name_id_pk'] ?>" <?php if ($formData['subject_name_id_fk'] == $subject['subject_name_id_pk']) echo "selected"; ?>>
