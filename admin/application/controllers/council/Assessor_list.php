...
class Assessor_list extends NIC_Controller 
{
    ...
    public function view_details($assessor_id_hash = NULL){
		...
		$data["docs"] = $this->assessor_list_model->get_assessor_document(1, $assessor_id_hash); //Added by Waseem on 09-07-2021
    ...
    public function download_doc_file($id = NULL){
		$file_content = $this->assessor_list_model->get_doc_file_content($id);
