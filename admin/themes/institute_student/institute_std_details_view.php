            ...
            <div class="box-body">
                ...
                <div class="row">
					...
					<div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input id="bengShikshaRegNo" name="bengShikshaRegNo" class="form-control" type="text" value="0<?php echo $app_data['bangla_shiksha_reg_number']; ?>">
                            <?php }else{?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $app_data['first_name']; ?>" placeholder="Enter First name" readonly />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="fname" name="fname" value="<?php echo set_value('fname') ?>" placeholder="Enter First name" readonly />
                            <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="mname" name="mname" value="<?php echo $app_data['middle_name']; ?>" placeholder="Enter Middle name" readonly  />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="mname" name="mname" value="<?php echo set_value('mname') ?>" placeholder="Enter Middle name" readonly/>
                            <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="lname" name="lname" value="<?php echo $app_data['last_name']; ?>" placeholder="Enter Last name"  readonly />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="lname" name="lname" value="<?php echo set_value('lname') ?>" placeholder="Enter Last name" readonly />
                            <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="guardian_name" name="guardian_name" value="<?php echo $app_data['guardian_name']; ?>" placeholder="Enter Mother name" readonly />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="guardian_name" name="guardian_name" value="<?php echo set_value('guardian_name') ?>" placeholder="Enter Guardian Name" readonly />
                            <?php } ?>
                    ...
                    <div class="col-md-4 citizenship_doc_div" <?php if (($formData['citizenship'] == 1) || ($formData['citizenship'] == NULL)) echo 'style="display: none;"'; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <small><a target="_blank" href="institute_student/student_list/download_citizenship_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="aadhar_no" name="aadhar_no" value="<?php echo $app_data['aadhar_no']; ?>" placeholder="Aadhar No." readonly  />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="aadhar_no" name="aadhar_no" value="<?php echo set_value('aadhar_no') ?>" placeholder="Aadhar No." readonly  />
                            <?php } ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="mob_no" name="mob_no" value="<?php echo $app_data['mobile_number']; ?>" placeholder="Mobile No." pattern="^[6-9]\d{9}$" title="10 Digit Mobile No, Starting with 6 to 9"   />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="mob_no" name="mob_no" value="<?php echo set_value('mob_no') ?>" placeholder="Mobile No." pattern="^[6-9]\d{9}$" title="Ten Digit Mobile No, Starting with 6 to 9"  />
                            <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input id="pinCode" name="pinCode" id="pinCode" class="form-control" type="text" value="<?php echo $app_data['pincode']; ?>" >
                    ...
                    <div class="col-md-4 caste_doc_div" <?php if (($formData['caste_id'] == 1) || ($formData['caste_id'] == NULL)) echo 'style="display: none;"'; ?>>
                        ...
                        <small><a target="_blank"href="institute_student/student_list/download_caste_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
                    ...
                    <div class="col-md-4 phy_challenged_doc_div" <?php if (($formData['phy_challenged'] == 0) || ($formData['phy_challenged'] == NULL)){ echo 'style="display: none;"';} ?>>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($app_data['phy_challenged_doc'] !='') {?>
                                ...
                                <small><a target="_blank"href="institute_student/student_list/download_handicap_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
                            <div class="input-group">
                                <label class="input-group-btn">
                                    <span class="btn btn-success">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group date">
                            ...
                            <div class="common_input_div">
                                <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                    <input type="text" class="form-control datepicker" id="dob" name="dob" value="<?php if($app_data['date_of_birth']!=''){echo date('d-m-Y', strtotime($app_data['date_of_birth']));} ?>" placeholder="DD-MM-YYYY"  />
                                <?php } else { ?>
                                    <input type="text" class="form-control datepicker" id="dob" name="dob" value="<?php echo set_value('dob') ?>" placeholder="Enter DOB" <?php echo $disabled; ?> />
                                <?php } ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <?php if($app_data['aadhar_doc'] !='') {?>
                                ...
                                <small><a target="_blank"href="institute_student/student_list/download_aadhaar_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                            <?php } ?>
                    ...
                    <div class="col-md-4 kanyashree_no_div" style="display:<?php echo $kanyas_view; ?>" >
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                            <input id="kanyashree_no" name="kanyashree_no" class="form-control" type="text"  value="<?php echo $app_data['kanyashree_no']; ?>" >
                            <?php } else { ?>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <small><a target="_blank"href="institute_student/student_list/download_marksheet_doc/<?php echo md5($app_data['institute_student_details_id_pk']); ?>" class="btn btn-sm btn-primary"><i class="fa fa-download" style="font-size:18px"> </i></a></small>
                        <?php } ?>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="board_id" id="board_id"  >
                                ...
                                <?php foreach ($board_name as $value) { ?>
                                    ...
                                    <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                        <option value="<?php echo $value['board_id_pk']; ?>" <?php echo $value['board_id_pk'] == $app_data['board_id_pk'] ? 'selected' : ''; ?>><?php echo $value['board_name']; ?></option>
                                    <?php } else { ?>
                                        <option value="<?php echo $value['board_id_pk']; ?>" <?php echo set_select('board_id', $value['board_id_pk']); ?>><?php echo $value['board_name']; ?></option>
                                    <?php } ?>
                                <?php }?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="text" class="form-control" id="institute_name" name="institute_name" value="<?php echo $app_data['institute_name']; ?>" placeholder="Institute Name" step=".01"  />
                            <?php } else { ?>
                                <input type="text" class="form-control" id="institute_name" name="institute_name" value="<?php echo set_value('institute_name') ?>" placeholder="Institute Name" step=".01"  />
                            <?php } ?>
                ...
                <div class="row" id="marks_submit_div" style="display:<?php echo $suj_marks_view; ?>;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="number" class="form-control" id="phy_marks" name="phy_marks" value="<?php echo $app_data['phy_marks']; ?>" placeholder="Marks of Physics" step=".01" />
                            <?php } else { ?>
                                <input type="number" class="form-control" id="phy_marks" name="phy_marks" value="<?php echo set_value('phy_marks') ?>" placeholder="Marks of Physics" step=".01" />
                            <?php } ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="number" class="form-control" id="chem_marks" name="chem_marks" value="<?php echo $app_data['chem_marks']; ?>" placeholder="Marks of Chemistry" step=".01" />
                            <?php } else { ?>
                                <input type="number" class="form-control" id="chem_marks" name="chem_marks" value="<?php echo set_value('chem_marks') ?>" placeholder="Marks of Chemistry" step=".01" />
                            <?php } ?>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <?php if ($this->input->method(TRUE) == 'GET') { ?>
                                <input type="number" class="form-control" id="math_bio_marks" name="math_bio_marks" value="<?php echo $app_data['math_bio_marks']; ?>" placeholder="Marks of Biology /Mathematics" step=".01" />
                            <?php } else { ?>
                                <input type="number" class="form-control" id="math_bio_marks" name="math_bio_marks" value="<?php echo set_value('math_bio_marks') ?>" placeholder="Marks of or Biology /Mathematics" step=".01" />
                            <?php } ?>
