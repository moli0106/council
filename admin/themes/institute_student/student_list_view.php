    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">Student data List
<a href ="<?php echo base_url('admin/institute_student/student_list/download_misinst_end'); ?>"> <button  type="button" class="btn btn-success" style="margin-left:1000px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php if(($student_data['approve_reject_status'] == 1) && ($student_data['council_approvedreject_status']== 1 || $student_data['council_approvedreject_status']== null) && ($student_data['eligible_for_exam']!= 1) && $student_data['reg_certificate_number']!=''){?>
							 ...
							 <td><?php echo $student_data['reg_certificate_number'] ?></td> 
                           ...
                           <!--  <td><?php echo $student_data['gender_description'] ?></td> -->
                            <td>
                                ...
                                Re Approved 
                                    ...
                                    <?php }else if($student_data['approve_reject_status']== '') { ?>
