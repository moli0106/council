...
<?php echo form_open("admin/institute_student/student_list/updateStudentApproveRejectStatus", array("id" => "approve_reject_form")); ?>
...
<div class="">
    <div class="row" style="display:none" id="approve_div">
        ...
        <div class="col-md-4 mb-4">
                <label class="radio-inline" for="management_quota_yes">
                    <input type="radio" class="form-check-input" name="management_quota" id="management_quota_yes" value="1"> Yes
                </label>
                <label class="radio-inline" for="management_quota_no">
                    <input type="radio" class="form-check-input" name="management_quota" id="management_quota_no" value="0"> No
                </label>
        </div>
    </div>
