...
<input type="hidden" name="exam_type_id_fk" id="exam_type" value="<?php echo $student_data['exam_type_id_fk']; ?>">

<div class="">

    <?php if(($student_data['exam_type_id_fk'] == '1') ||($student_data['exam_type_id_fk'] == '2') ||($student_data['exam_type_id_fk'] == '3')) { ?>
