$(document).ready(function () {
    ...
    $(document).on('change', '#course_id', function () {
        ...
        Swal.fire({
            ...
            didOpen: () => {
                Swal.showLoading();
                $.ajax({
                    url: "qbm/questions_qm/get_semester_subject_list/",
                    dataType: "json",
    ...
    $(document).on('change', '#subject_id', function () {
        ...
        var ajax_url = "qbm/questions_qm/get_topic_chapter/";
    ...
    $(document).on('click', '.view-question-details', function () {
        ...
        $.ajax({
            url: "qbm/questions_qm/question_details/" + id_hash,
            type: 'GET',
            dataType: "json",
        })
    ...
    $(document).on('click', '.add-multi-lang-question', function () {
        ...
        $.ajax({
            url: "qbm/questions_qm/addMultiLangQuestion/" + id_hash,
            type: 'GET',
            dataType: "json",
        })
            .done(function (response) {
    ...
    $(document).on('click', '.remove-question', function () {
        ...
        Swal.fire({
            title: 'Are you sure? Reject Question from List.',
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    ...
                    didOpen: () => {
                        ...
                        $.ajax({
                            url: "qbm/questions_qm/remove_question/" + id_hash,
                            dataType: "json",
                        })
                            .done(function (res) {
                                this_tr.remove();
                                Swal.fire('Success!', 'Question has been successfully Rejected.', 'success');
                            })
                            .fail(function (res) {
    ...
    $(document).on('change', '#qb_list_semester_id', function (e) {
        ...
        Swal.fire({
            ...
            didOpen: () => {
                ...
                $.ajax({
                    url: "qbm/questions_qm/getQuestionListBySemSubj/",
                    dataType: "json",
