$(document).ready(function () {
		...
		if (course_id == 1 || course_id == 2) {
			Swal.fire({
				...
				didOpen: () => {
					Swal.showLoading();
					$.ajax({
						url: "qbm/questions/get_semester_subject_list/",
						dataType: "json",
			...
			Swal.fire({
				...
				didOpen: () => {
					Swal.showLoading();
					$.ajax({
						url: "qbm/questions/get_semester_list/",
						dataType: "json",
						data: { course_id: course_id },
					})
						.done(function (res) {
		...
		if (course_id == 3 || course_id == 4) {
			Swal.fire({
				...
				didOpen: () => {
					Swal.showLoading();
					$.ajax({
						url: "qbm/questions/get_subject_list_by_course_sem/",
						dataType: "json",
						data: { course_id: course_id, sam_year_id: sam_year_id },
					})
						.done(function (res) {
							//$("#sam_year_id").html(res.semester_html_view);
							$("#subject_id").html(res.subject_html_view);
    ...
    $(document).on('change', '#subject_id', function () {
        ...
        var ajax_url = "qbm/questions/get_topic_chapter/";
    ...
    $(document).on('click', '.btn-next', function () {
        ...
        $(".question-box").find('input,textarea,select').each(function () {
    ...
    $(document).on('click', '.view-question-details', function () {
        ...
        $.ajax({
            url: "qbm/questions/question_details/" + id_hash,
            type: 'GET',
            dataType: "json",
        })
    ...
    $(document).on('click', '.add-multi-lang-question', function () {
        ...
        $.ajax({
            url: "qbm/questions/addMultiLangQuestion/" + id_hash,
            type: 'GET',
            dataType: "json",
        })
            .done(function (response) {
    ...
    $(document).on('click', '.remove-question', function () {
        ...
        Swal.fire({
            title: 'Are you sure? Remove Question from List.',
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    ...
                    didOpen: () => {
                        ...
                        $.ajax({
                            url: "qbm/questions/remove_question/" + id_hash,
                            dataType: "json",
                        })
                            .done(function (res) {
                                this_tr.remove();
                                Swal.fire('Success!', 'Question has been successfully removed.', 'success');
                            })
                            .fail(function (res) {
                                Swal.fire('Warning!', 'Oops! Unable to remove question.', 'warning');
                            });
                    }
                })
            }
    ...
    $(document).on('change', '#qb_list_semester_id', function (e) {
        ...
        Swal.fire({
            ...
            didOpen: () => {
                ...
                $.ajax({
                    url: "qbm/questions/getQuestionListBySemSubj/",
                    dataType: "json",
    ...
    $(document).on('click', '#forwardQuestionBtn', function (e) {
        ...
        Swal.fire({
            title: 'Are you sure? Save Question Set.',
                    ...
                    didOpen: () => {
                        ...
                        $.ajax({
                            ...
                            .done(function (res) {
                                ...
                                Swal.fire('Success!', 'Question set has been successfully saved.', 'success');
                            })
                            .fail(function (res) {
