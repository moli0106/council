$(document).ready(function () {
    ...
    var selected_year = $('#selected_year').val();
        ...
        $('#editable-sample').DataTable({
            ...
            "pageLength": 50,
            "ajax": {
            "url": "vtc_student/student/get_list",
            "dataType": "json",
            "type": "GET",
            "data": {
	...
	$(document).on('change', '#district', function() {
        ...
        $.ajax({
                url: "vtc_student/student/getSubDivision/" + district,
                dataType: "JSON",
            })
            .done(function(res) {
	...
	$(document).on('change', '#subDivision', function() {
        ...
        $.ajax({
                url: "vtc_student/student/getMunicipality/" + subDivision,
                dataType: "JSON",
            })
            .done(function(res) {
                $('#municipality').html(res);
    ...
    $(document).on('change', '#course_name_id', function() {
        ...
        $.ajax({
            url: "vtc_student/student/getGroupName/" + course_name_id,
            type: 'GET',
    ...
    $(document).on('click', '.approve-reject-modal', function() {
        ...
        $.ajax({
                url: "vtc_student/student/showApproveRejectModal/" + id_hash,
                type: 'GET',
                dataType: "json",
            })
            .done(function(response) {
    ...
    $(document).on('click', '.modal-reject-note', function() {
        ...
        $.ajax({
                url: "vtc_student/student/getRejectNote/" + id_hash,
                type: 'GET',
                dataType: "json",
            })
            .done(function(response) {
    ...
    function getDuration(course_name_id , group_id) {
        ...
        $.ajax({
            url: "vtc_student/student/getDuration/" + course_name_id,
            type: 'GET',
    ...
    $(document).on('change', '#state', function() {
        ...
        $.ajax({
                url: "vtc_student/student/getDistrict/" + state,
                dataType: "JSON",
            })
            .done(function(res) {
                $('#district').html(res);
