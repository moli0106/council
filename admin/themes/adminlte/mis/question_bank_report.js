$(document).ready(function () {
    ...
    $("#sector_id").change(function(){
		...
		var url = 'mis/question_bank_report/get_course/'+ sector_id;
		$.ajax({
			url: url,
	...
	$("#question_for_id").change(function(){
		...
		if(question_for_id=='1'){
			var url = 'mis/question_bank_report/get_question_type_trainee';
			$.ajax({
				url: url,
				success: function(result){
			...
			var url = 'mis/question_bank_report/get_question_type_assessor';
			$.ajax({
				url: url,
				success: function(result){
					$("#question_type_id").html(result);
